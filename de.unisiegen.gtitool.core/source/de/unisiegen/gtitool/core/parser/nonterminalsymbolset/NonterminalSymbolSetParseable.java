...
/**
 * The {@link NonterminalSymbol} set {@link Parseable} class.
 * 
 * @author Christian Fehler
 * @version $Id: NonterminalSymbolSetParseable.java 553 2008-02-11 23:13:37Z
 *          fehler $
 */
public final class NonterminalSymbolSetParseable implements Parseable
{
  ...
  public final GTIParser newParser ( GTIScanner gtiScanner )
  {
    ...
    final lr_parser parser = new NonterminalSymbolSetParser ( gtiScanner );
    return new GTIParser ()
    {

      public NonterminalSymbolSet parse () throws Exception
      {
        return ( NonterminalSymbolSet ) parser.parse ().value;
      }
    };
  }
  ...
  public final GTIScanner newScanner ( String text )
  {
    ...
    return new NonterminalSymbolSetScanner ( new StringReader ( text ) );
  }
}
