...
/**
 * The {@link State} set parser class.
 * 
 * @author Christian Fehler
 * @version $Id$
 */
public final class StateSetParser extends StateSetAbstractParser
{

  /**
   * Allocates a new {@link StateSetParser}.
   * 
   * @param gtiScanner The {@link GTIScanner}.
   */
  public StateSetParser ( GTIScanner gtiScanner )
  {
    super ( gtiScanner );
  }
