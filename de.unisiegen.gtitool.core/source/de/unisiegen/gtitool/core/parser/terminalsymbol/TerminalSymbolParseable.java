...
/**
 * The {@link TerminalSymbol} {@link Parseable} class.
 * 
 * @author Christian Fehler
 * @version $Id$
 */
public final class TerminalSymbolParseable implements Parseable
{
  ...
  public final GTIParser newParser ( GTIScanner gtiScanner )
  {
    ...
    final lr_parser parser = new TerminalSymbolParser ( gtiScanner );
    return new GTIParser ()
    {

      public TerminalSymbol parse () throws Exception
      {
        return ( TerminalSymbol ) parser.parse ().value;
      }
    };
  }
  ...
  public final GTIScanner newScanner ( String text )
  {
    ...
    return new TerminalSymbolScanner ( new StringReader ( text ) );
  }
}
