...
@SuppressWarnings (
{ "all" } )
public class ConfirmDialogForm extends javax.swing.JDialog
{
  ...
  /**
   * Creates new form {@link ConfirmDialogForm}.
   * 
   * @param logic The {@link ConfirmDialog}.
   * @param parent The parent {@link Frame}.
   */
  public ConfirmDialogForm ( ConfirmDialog logic, java.awt.Frame parent )
  {
    super ( parent, true );
    this.logic = logic;
    initComponents ();
  ...
  // <editor-fold defaultstate="collapsed" desc=" Generated Code
    ...
    private void initComponents() {
        ...
        setSize(new java.awt.Dimension(330, 130));
