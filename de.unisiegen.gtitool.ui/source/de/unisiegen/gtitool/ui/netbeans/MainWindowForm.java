...
public class MainWindowForm extends JFrame implements GUIClass < MainWindow >
{
  ...
  // <editor-fold defaultstate="collapsed"
    ...
    private void initComponents() {
        ...
        jMenuItemCreateParsingTableStepwise.setMnemonic(java.util.ResourceBundle.getBundle("de/unisiegen/gtitool/ui/i18n/messages").getString("MainWindow.CreateParsingTableStepWiseMnemonic").charAt(0));
        jMenuItemCreateParsingTableStepwise.setText(bundle.getString("MainWindow.CreateParsingTableStepWise")); // NOI18N
        jMenuItemCreateParsingTableStepwise.setToolTipText("");
        ...
        jMenuItemParsingTableFindEntries.setToolTipText("");
