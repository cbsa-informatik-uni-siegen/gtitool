...
public class MainWindowForm extends JFrame implements GUIClass < MainWindow >
{
  ...
  public final javax.swing.JMenuItem getJMenuItemConvertToLR0Automaton ()
  {
    return this.jMenuItemConvertToLR0;
  }


  public final javax.swing.JMenuItem getJMenuItemConvertToLR1Automaton ()
  {
    return this.jMenuItemConvertToLR1;
  }


  public final javax.swing.JMenuItem getJMenuItemConvertToLALR1Automaton ()
  {
    return this.jMenuItemConvertToLALR1;
  }


  public final javax.swing.JMenuItem getJMenuItemConvertToLR0Parser ()
  {
    return this.jMenuItemConvertToLR0Parser;
  }


  public final javax.swing.JMenuItem getJMenuItemConvertToLR1Parser ()
  {
    return this.jMenuItemConvertToLR1Parser;
  }


  public final javax.swing.JMenuItem getJMenuItemConvertToLALR1Parser ()
  {
    return this.jMenuItemConvertToLALR1Parser;
  }


  public final javax.swing.JMenuItem getJMenuItemConvertToSLRParser ()
  {
    return this.jMenuItemSLRParser;
  }
  ...
  {
    return this.jMenuItemConvertToNFACB;
  }
  ...
  /**
   * Returns the jMenuItemParsingTableFindEntries
   * 
   * @return The jMenuItemParsingTableFindEntries
   */
  public JMenuItem getJMenuItemFindParsingTableEntries ()
  {
    return this.jMenuItemParsingTableFindEntries;
  }
  ...
  private void initComponents ()
  {
    ...
    jGTIToolBarButtonNew.setIcon ( new javax.swing.ImageIcon ( getClass ()
        .getResource ( "/de/unisiegen/gtitool/ui/icon/large/new.png" ) ) ); // NOI18N
    java.util.ResourceBundle bundle = java.util.ResourceBundle
        .getBundle ( "de/unisiegen/gtitool/ui/i18n/messages" ); // NOI18N
    jGTIToolBarButtonNew.setToolTipText ( bundle
        .getString ( "MainWindow.NewToolTip" ) ); // NOI18N
    jGTIToolBarButtonNew
    ...
    jGTIToolBarButtonOpen.setIcon ( new javax.swing.ImageIcon ( getClass ()
        .getResource ( "/de/unisiegen/gtitool/ui/icon/large/open.png" ) ) ); // NOI18N
    jGTIToolBarButtonOpen.setToolTipText ( bundle
        .getString ( "MainWindow.OpenToolTip" ) ); // NOI18N
    jGTIToolBarButtonOpen
        .addActionListener ( new java.awt.event.ActionListener ()
        {
    ...
    jGTIToolBarButtonSave.setIcon ( new javax.swing.ImageIcon ( getClass ()
        .getResource ( "/de/unisiegen/gtitool/ui/icon/large/save.png" ) ) ); // NOI18N
    jGTIToolBarButtonSave.setToolTipText ( bundle
        .getString ( "MainWindow.SaveToolTip" ) ); // NOI18N
    jGTIToolBarButtonSave
        .addActionListener ( new java.awt.event.ActionListener ()
        {
    ...
    jGTIToolBarButtonSaveAs.setIcon ( new javax.swing.ImageIcon ( getClass ()
        .getResource ( "/de/unisiegen/gtitool/ui/icon/large/saveAs.png" ) ) ); // NOI18N
    jGTIToolBarButtonSaveAs.setToolTipText ( bundle
        .getString ( "MainWindow.SaveAsToolTip" ) ); // NOI18N
    jGTIToolBarButtonSaveAs
        .addActionListener ( new java.awt.event.ActionListener ()
        {
    ...
    jGTIToolBarButtonUndo.setIcon ( new javax.swing.ImageIcon ( getClass ()
        .getResource ( "/de/unisiegen/gtitool/ui/icon/large/undo.png" ) ) ); // NOI18N
    jGTIToolBarButtonUndo.setToolTipText ( bundle
        .getString ( "MainWindow.UndoToolTip" ) ); // NOI18N
    jGTIToolBarButtonUndo
        .addActionListener ( new java.awt.event.ActionListener ()
        {
    ...
    jGTIToolBarButtonRedo.setIcon ( new javax.swing.ImageIcon ( getClass ()
        .getResource ( "/de/unisiegen/gtitool/ui/icon/large/redo.png" ) ) ); // NOI18N
    jGTIToolBarButtonRedo.setToolTipText ( bundle
        .getString ( "MainWindow.RedoToolTip" ) ); // NOI18N
    jGTIToolBarButtonRedo
        .addActionListener ( new java.awt.event.ActionListener ()
        {
    ...
    jGTIToolBarButtonEditDocument.setIcon ( new javax.swing.ImageIcon (
        getClass ().getResource (
            "/de/unisiegen/gtitool/ui/icon/large/document.png" ) ) ); // NOI18N
    jGTIToolBarButtonEditDocument.setToolTipText ( bundle
        .getString ( "MachinePanel.EditDocument" ) ); // NOI18N
    jGTIToolBarButtonEditDocument
        .addActionListener ( new java.awt.event.ActionListener ()
        {
    ...
    jGTIToolBarToggleButtonMouse.setIcon ( new javax.swing.ImageIcon (
        getClass ().getResource (
            "/de/unisiegen/gtitool/ui/icon/machine/mouse.png" ) ) ); // NOI18N
    jGTIToolBarToggleButtonMouse.setSelected ( true );
    jGTIToolBarToggleButtonMouse.setToolTipText ( bundle
        .getString ( "MachinePanel.Mouse" ) ); // NOI18N
    jGTIToolBarToggleButtonMouse
    ...
    jGTIToolBarToggleButtonAddState.setIcon ( new javax.swing.ImageIcon (
        getClass ().getResource (
            "/de/unisiegen/gtitool/ui/icon/machine/state.png" ) ) ); // NOI18N
    jGTIToolBarToggleButtonAddState.setToolTipText ( bundle
        .getString ( "MachinePanel.AddState" ) ); // NOI18N
    jGTIToolBarToggleButtonAddState
        .addItemListener ( new java.awt.event.ItemListener ()
        {
    ...
    jGTIToolBarToggleButtonAddTransition.setIcon ( new javax.swing.ImageIcon (
        getClass ().getResource (
            "/de/unisiegen/gtitool/ui/icon/machine/transition.png" ) ) ); // NOI18N
    jGTIToolBarToggleButtonAddTransition.setToolTipText ( bundle
        .getString ( "MachinePanel.AddTransition" ) ); // NOI18N
    jGTIToolBarToggleButtonAddTransition
        .addItemListener ( new java.awt.event.ItemListener ()
        {
    ...
    jGTIToolBarToggleButtonStartState.setIcon ( new javax.swing.ImageIcon (
        getClass ().getResource (
            "/de/unisiegen/gtitool/ui/icon/machine/start.png" ) ) ); // NOI18N
    jGTIToolBarToggleButtonStartState.setToolTipText ( bundle
        .getString ( "MachinePanel.AddStartState" ) ); // NOI18N
    jGTIToolBarToggleButtonStartState
        .addItemListener ( new java.awt.event.ItemListener ()
        {
    ...
    jGTIToolBarToggleButtonFinalState.setIcon ( new javax.swing.ImageIcon (
        getClass ().getResource (
            "/de/unisiegen/gtitool/ui/icon/machine/final.png" ) ) ); // NOI18N
    jGTIToolBarToggleButtonFinalState.setToolTipText ( bundle
        .getString ( "MachinePanel.AddFinalState" ) ); // NOI18N
    jGTIToolBarToggleButtonFinalState
        .addItemListener ( new java.awt.event.ItemListener ()
        {
    ...
    jGTIToolBarToggleButtonEnterWord.setIcon ( new javax.swing.ImageIcon (
        getClass ().getResource (
            "/de/unisiegen/gtitool/ui/icon/machine/word.png" ) ) ); // NOI18N
    jGTIToolBarToggleButtonEnterWord.setToolTipText ( bundle
        .getString ( "MainWindow.EnterWord" ) ); // NOI18N
    jGTIToolBarToggleButtonEnterWord
        .addItemListener ( new java.awt.event.ItemListener ()
        {
    ...
    jGTIToolBarButtonAddProduction.setIcon ( new javax.swing.ImageIcon (
        getClass ().getResource (
            "/de/unisiegen/gtitool/ui/icon/grammar/large/add.png" ) ) ); // NOI18N
    jGTIToolBarButtonAddProduction.setToolTipText ( bundle
        .getString ( "GrammarPanel.AddProduction" ) ); // NOI18N
    jGTIToolBarButtonAddProduction
        .addActionListener ( new java.awt.event.ActionListener ()
        {
    ...
    jGTIToolBarButtonStart.setIcon ( new javax.swing.ImageIcon ( getClass ()
        .getResource (
            "/de/unisiegen/gtitool/ui/icon/navigation/large/start.png" ) ) ); // NOI18N
    jGTIToolBarButtonStart.setToolTipText ( bundle
        .getString ( "MachinePanel.WordModeStart" ) ); // NOI18N
    jGTIToolBarButtonStart
        .addActionListener ( new java.awt.event.ActionListener ()
        {
    ...
    jGTIToolBarButtonPreviousStep.setIcon ( new javax.swing.ImageIcon (
        getClass ().getResource (
            "/de/unisiegen/gtitool/ui/icon/navigation/large/backward.png" ) ) ); // NOI18N
    jGTIToolBarButtonPreviousStep.setToolTipText ( bundle
        .getString ( "MachinePanel.WordModePreviousStep" ) ); // NOI18N
    jGTIToolBarButtonPreviousStep
        .addActionListener ( new java.awt.event.ActionListener ()
        {
    ...
    jGTIToolBarButtonNextStep.setIcon ( new javax.swing.ImageIcon ( getClass ()
        .getResource (
            "/de/unisiegen/gtitool/ui/icon/navigation/large/forward.png" ) ) ); // NOI18N
    jGTIToolBarButtonNextStep.setToolTipText ( bundle
        .getString ( "MachinePanel.WordModeNextStep" ) ); // NOI18N
    jGTIToolBarButtonNextStep
        .addActionListener ( new java.awt.event.ActionListener ()
        {
    ...
    jGTIToolBarToggleButtonAutoStep.setIcon ( new javax.swing.ImageIcon (
        getClass ().getResource (
            "/de/unisiegen/gtitool/ui/icon/navigation/large/autostep.png" ) ) ); // NOI18N
    jGTIToolBarToggleButtonAutoStep.setToolTipText ( bundle
        .getString ( "MachinePanel.WordModeAutoStep" ) ); // NOI18N
    jGTIToolBarToggleButtonAutoStep
        .addItemListener ( new java.awt.event.ItemListener ()
        {
    ...
    jGTIToolBarButtonStop.setIcon ( new javax.swing.ImageIcon ( getClass ()
        .getResource (
            "/de/unisiegen/gtitool/ui/icon/navigation/large/stop.png" ) ) ); // NOI18N
    jGTIToolBarButtonStop.setToolTipText ( bundle
        .getString ( "MachinePanel.WordModeStop" ) ); // NOI18N
    jGTIToolBarButtonStop
        .addActionListener ( new java.awt.event.ActionListener ()
        {
    ...
    jGTIPanelLeftInner.setBorder ( new javax.swing.border.LineBorder (
        new java.awt.Color ( 50, 150, 250 ), 3, true ) );

    jGTIEditorPanelTabbedPaneLeft
    ...
    jGTIPanelRightInner.setBorder ( new javax.swing.border.LineBorder (
        new java.awt.Color ( 100, 200, 250 ), 3, true ) );

    jGTIEditorPanelTabbedPaneRight
        .addMouseListener ( new java.awt.event.MouseAdapter ()
        {
    ...
    gridBagConstraints.weighty = 1.0;
    gridBagConstraints.insets = new java.awt.Insets ( 3, 3, 3, 3 );
    jGTIPanelRightInner.add ( jGTIEditorPanelTabbedPaneRight,
        gridBagConstraints );
    ...
    jMenuFile.setMnemonic ( java.util.ResourceBundle.getBundle (
        "de/unisiegen/gtitool/ui/i18n/messages" ).getString (
        "MainWindow.FileMnemonic" ).charAt ( 0 ) );
    ...
    jMenuItemNew.setIcon ( new javax.swing.ImageIcon ( getClass ().getResource (
        "/de/unisiegen/gtitool/ui/icon/small/new.png" ) ) ); // NOI18N
    jMenuItemNew.setMnemonic ( java.util.ResourceBundle.getBundle (
        "de/unisiegen/gtitool/ui/i18n/messages" ).getString (
        "MainWindow.NewMnemonic" ).charAt ( 0 ) );
    ...
    jMenuItemOpen.setIcon ( new javax.swing.ImageIcon ( getClass ()
        .getResource ( "/de/unisiegen/gtitool/ui/icon/small/open.png" ) ) ); // NOI18N
    jMenuItemOpen.setMnemonic ( java.util.ResourceBundle.getBundle (
        "de/unisiegen/gtitool/ui/i18n/messages" ).getString (
        "MainWindow.OpenMnemonic" ).charAt ( 0 ) );
    ...
    jMenuItemClose.setIcon ( new javax.swing.ImageIcon ( getClass ()
        .getResource ( "/de/unisiegen/gtitool/ui/icon/small/empty.png" ) ) ); // NOI18N
    jMenuItemClose.setMnemonic ( java.util.ResourceBundle.getBundle (
        "de/unisiegen/gtitool/ui/i18n/messages" ).getString (
        "MainWindow.CloseMnemonic" ).charAt ( 0 ) );
    ...
    jMenuItemCloseAll.setAccelerator ( javax.swing.KeyStroke.getKeyStroke (
        java.awt.event.KeyEvent.VK_W, java.awt.event.InputEvent.SHIFT_MASK
            | java.awt.event.InputEvent.CTRL_MASK ) );
    jMenuItemCloseAll.setIcon ( new javax.swing.ImageIcon ( getClass ()
        .getResource ( "/de/unisiegen/gtitool/ui/icon/small/empty.png" ) ) ); // NOI18N
    jMenuItemCloseAll.setMnemonic ( java.util.ResourceBundle.getBundle (
        "de/unisiegen/gtitool/ui/i18n/messages" ).getString (
        "MainWindow.CloseAllMnemonic" ).charAt ( 0 ) );
    ...
    jMenuItemPrint.setAccelerator ( javax.swing.KeyStroke.getKeyStroke (
        java.awt.event.KeyEvent.VK_P, java.awt.event.InputEvent.CTRL_MASK ) );
    jMenuItemPrint.setIcon ( new javax.swing.ImageIcon ( getClass ()
        .getResource ( "/de/unisiegen/gtitool/ui/icon/small/print.png" ) ) ); // NOI18N
    jMenuItemPrint.setMnemonic ( java.util.ResourceBundle.getBundle (
        "de/unisiegen/gtitool/ui/i18n/messages" ).getString (
        "MainWindow.PrintMnemonic" ).charAt ( 0 ) );
    ...
    jMenuItemSave.setAccelerator ( javax.swing.KeyStroke.getKeyStroke (
        java.awt.event.KeyEvent.VK_S, java.awt.event.InputEvent.CTRL_MASK ) );
    jMenuItemSave.setIcon ( new javax.swing.ImageIcon ( getClass ()
        .getResource ( "/de/unisiegen/gtitool/ui/icon/small/save.png" ) ) ); // NOI18N
    jMenuItemSave.setMnemonic ( java.util.ResourceBundle.getBundle (
        "de/unisiegen/gtitool/ui/i18n/messages" ).getString (
        "MainWindow.SaveMnemonic" ).charAt ( 0 ) );
    ...
    jMenuItemSaveAs.setIcon ( new javax.swing.ImageIcon ( getClass ()
        .getResource ( "/de/unisiegen/gtitool/ui/icon/small/saveAs.png" ) ) ); // NOI18N
    jMenuItemSaveAs.setMnemonic ( java.util.ResourceBundle.getBundle (
        "de/unisiegen/gtitool/ui/i18n/messages" ).getString (
        "MainWindow.SaveAsMnemonic" ).charAt ( 0 ) );
    ...
    jMenuItemSaveAll.setAccelerator ( javax.swing.KeyStroke.getKeyStroke (
        java.awt.event.KeyEvent.VK_S, java.awt.event.InputEvent.SHIFT_MASK
            | java.awt.event.InputEvent.CTRL_MASK ) );
    jMenuItemSaveAll.setIcon ( new javax.swing.ImageIcon ( getClass ()
        .getResource ( "/de/unisiegen/gtitool/ui/icon/small/saveAll.png" ) ) ); // NOI18N
    jMenuItemSaveAll.setMnemonic ( java.util.ResourceBundle.getBundle (
        "de/unisiegen/gtitool/ui/i18n/messages" ).getString (
        "MainWindow.SaveAllMnemonic" ).charAt ( 0 ) );
    ...
    jMenuItemExportPicture.setMnemonic ( java.util.ResourceBundle.getBundle (
        "de/unisiegen/gtitool/ui/i18n/messages" ).getString (
        "MainWindow.ExportPictureMnemonic" ).charAt ( 0 ) );
    jMenuItemExportPicture.setText ( bundle
        .getString ( "MainWindow.ExportPicture" ) ); // NOI18N
    jMenuItemExportPicture
        .addActionListener ( new java.awt.event.ActionListener ()
        {
    ...
    jMenuItemExportLatex.setAccelerator ( javax.swing.KeyStroke.getKeyStroke (
        java.awt.event.KeyEvent.VK_L, java.awt.event.InputEvent.SHIFT_MASK
            | java.awt.event.InputEvent.CTRL_MASK ) );
    jMenuItemExportLatex.setMnemonic ( java.util.ResourceBundle.getBundle (
        "de/unisiegen/gtitool/ui/i18n/messages" ).getString (
        "MainWindow.LatexExportMnemonic" ).charAt ( 0 ) );
    jMenuItemExportLatex
        .setText ( bundle.getString ( "MainWindow.LatexExport" ) ); // NOI18N
    jMenuItemExportLatex
        .addActionListener ( new java.awt.event.ActionListener ()
        {
    ...
    jMenuRecentlyUsed.setIcon ( new javax.swing.ImageIcon ( getClass ()
        .getResource ( "/de/unisiegen/gtitool/ui/icon/small/empty.png" ) ) ); // NOI18N
    jMenuRecentlyUsed.setMnemonic ( java.util.ResourceBundle.getBundle (
        "de/unisiegen/gtitool/ui/i18n/messages" ).getString (
        "MainWindow.RecentlyUsedMnemonic" ).charAt ( 0 ) );
    ...
    jMenuItemQuit.setAccelerator ( javax.swing.KeyStroke.getKeyStroke (
        java.awt.event.KeyEvent.VK_Q, java.awt.event.InputEvent.CTRL_MASK ) );
    jMenuItemQuit.setIcon ( new javax.swing.ImageIcon ( getClass ()
        .getResource ( "/de/unisiegen/gtitool/ui/icon/small/empty.png" ) ) ); // NOI18N
    jMenuItemQuit.setMnemonic ( java.util.ResourceBundle.getBundle (
        "de/unisiegen/gtitool/ui/i18n/messages" ).getString (
        "MainWindow.QuitMnemonic" ).charAt ( 0 ) );
    ...
    jMenuEdit.setMnemonic ( java.util.ResourceBundle.getBundle (
        "de/unisiegen/gtitool/ui/i18n/messages" ).getString (
        "MainWindow.EditMnemonic" ).charAt ( 0 ) );
    jMenuEdit.setText ( bundle.getString ( "MainWindow.Edit" ) ); // NOI18N

    jMenuItemUndo.setAccelerator ( javax.swing.KeyStroke.getKeyStroke (
        java.awt.event.KeyEvent.VK_Z, java.awt.event.InputEvent.CTRL_MASK ) );
    jMenuItemUndo.setIcon ( new javax.swing.ImageIcon ( getClass ()
        .getResource ( "/de/unisiegen/gtitool/ui/icon/small/undo.png" ) ) ); // NOI18N
    jMenuItemUndo.setMnemonic ( java.util.ResourceBundle.getBundle (
        "de/unisiegen/gtitool/ui/i18n/messages" ).getString (
        "MainWindow.UndoMnemonic" ).charAt ( 0 ) );
    ...
    jMenuItemRedo.setAccelerator ( javax.swing.KeyStroke.getKeyStroke (
        java.awt.event.KeyEvent.VK_Y, java.awt.event.InputEvent.CTRL_MASK ) );
    jMenuItemRedo.setIcon ( new javax.swing.ImageIcon ( getClass ()
        .getResource ( "/de/unisiegen/gtitool/ui/icon/small/redo.png" ) ) ); // NOI18N
    jMenuItemRedo.setMnemonic ( java.util.ResourceBundle.getBundle (
        "de/unisiegen/gtitool/ui/i18n/messages" ).getString (
        "MainWindow.RedoMnemonic" ).charAt ( 0 ) );
    ...
    jMenuItemPreferences
        .setIcon ( new javax.swing.ImageIcon ( getClass ().getResource (
            "/de/unisiegen/gtitool/ui/icon/small/preferences.png" ) ) ); // NOI18N
    jMenuItemPreferences.setMnemonic ( java.util.ResourceBundle.getBundle (
        "de/unisiegen/gtitool/ui/i18n/messages" ).getString (
        "MainWindow.PreferencesMnemonic" ).charAt ( 0 ) );
    jMenuItemPreferences
        .setText ( bundle.getString ( "MainWindow.Preferences" ) ); // NOI18N
    jMenuItemPreferences
        .addActionListener ( new java.awt.event.ActionListener ()
        {
    ...
    jMenuView.setMnemonic ( java.util.ResourceBundle.getBundle (
        "de/unisiegen/gtitool/ui/i18n/messages" ).getString (
        "MainWindow.ViewMnemonic" ).charAt ( 0 ) );
    jMenuView.setText ( bundle.getString ( "MainWindow.View" ) ); // NOI18N

    jCheckBoxMenuItemConsole.setMnemonic ( java.util.ResourceBundle.getBundle (
        "de/unisiegen/gtitool/ui/i18n/messages" ).getString (
        "MainWindow.ConsoleMnemonic" ).charAt ( 0 ) );
    jCheckBoxMenuItemConsole.setSelected ( true );
    jCheckBoxMenuItemConsole
        .setText ( bundle.getString ( "MainWindow.Console" ) ); // NOI18N
    jCheckBoxMenuItemConsole
        .addItemListener ( new java.awt.event.ItemListener ()
        {
    ...
    jCheckBoxMenuItemTable.setMnemonic ( java.util.ResourceBundle.getBundle (
        "de/unisiegen/gtitool/ui/i18n/messages" ).getString (
        "MainWindow.TableMnemonic" ).charAt ( 0 ) );
    ...
    jCheckBoxMenuItemRegexInfo.setMnemonic ( java.util.ResourceBundle
        .getBundle ( "de/unisiegen/gtitool/ui/i18n/messages" ).getString (
            "MainWindow.RegexInfoMnemonic" ).charAt ( 0 ) );
    jCheckBoxMenuItemRegexInfo.setSelected ( true );
    jCheckBoxMenuItemRegexInfo.setText ( bundle
        .getString ( "MainWindow.RegexInfo" ) ); // NOI18N
    jCheckBoxMenuItemRegexInfo
        .addItemListener ( new java.awt.event.ItemListener ()
        {
    ...
    jCheckBoxMenuItemSecondView.setMnemonic ( java.util.ResourceBundle
        .getBundle ( "de/unisiegen/gtitool/ui/i18n/messages" ).getString (
            "MainWindow.SecondViewMnemonic" ).charAt ( 0 ) );
    jCheckBoxMenuItemSecondView.setText ( bundle
        .getString ( "MainWindow.SecondView" ) ); // NOI18N
    jCheckBoxMenuItemSecondView
        .addItemListener ( new java.awt.event.ItemListener ()
        {
    ...
    jMenuExecute.setMnemonic ( java.util.ResourceBundle.getBundle (
        "de/unisiegen/gtitool/ui/i18n/messages" ).getString (
        "MainWindow.ExecuteMnemonic" ).charAt ( 0 ) );
    jMenuExecute.setText ( bundle.getString ( "MainWindow.Execute" ) ); // NOI18N

    jMenuItemEnterWord.setMnemonic ( java.util.ResourceBundle.getBundle (
        "de/unisiegen/gtitool/ui/i18n/messages" ).getString (
        "MainWindow.EnterWordMnemonic" ).charAt ( 0 ) );
    ...
    jMenuItemEditMachine.setMnemonic ( java.util.ResourceBundle.getBundle (
        "de/unisiegen/gtitool/ui/i18n/messages" ).getString (
        "MainWindow.EditMachineMnemonic" ).charAt ( 0 ) );
    jMenuItemEditMachine
        .setText ( bundle.getString ( "MainWindow.EditMachine" ) ); // NOI18N
    jMenuItemEditMachine
        .addActionListener ( new java.awt.event.ActionListener ()
        {
    ...
    jMenuItemValidate.setMnemonic ( java.util.ResourceBundle.getBundle (
        "de/unisiegen/gtitool/ui/i18n/messages" ).getString (
        "MainWindow.ValidateMnemonic" ).charAt ( 0 ) );
    ...
    jMenuConvertTo.setMnemonic ( java.util.ResourceBundle.getBundle (
        "de/unisiegen/gtitool/ui/i18n/messages" ).getString (
        "MainWindow.ConvertToMnemonic" ).charAt ( 0 ) );
    ...
    jMenuItemConvertToLR0.setMnemonic ( java.util.ResourceBundle.getBundle (
        "de/unisiegen/gtitool/ui/i18n/messages" ).getString (
        "MainWindow.LR0Mnemonic" ).charAt ( 0 ) );
    jMenuItemConvertToLR0.setText ( bundle.getString ( "MainWindow.LR0" ) ); // NOI18N
    jMenuItemConvertToLR0
        .addActionListener ( new java.awt.event.ActionListener ()
        {
    ...
    jMenuItemConvertToLR1.setMnemonic ( java.util.ResourceBundle.getBundle (
        "de/unisiegen/gtitool/ui/i18n/messages" ).getString (
        "MainWindow.LR1Mnemonic" ).charAt ( 0 ) );
    jMenuItemConvertToLR1.setText ( bundle.getString ( "MainWindow.LR1" ) ); // NOI18N
    jMenuItemConvertToLR1
        .addActionListener ( new java.awt.event.ActionListener ()
        {
    ...
    jMenuItemConvertToLR0Parser.setMnemonic ( java.util.ResourceBundle
        .getBundle ( "de/unisiegen/gtitool/ui/i18n/messages" ).getString (
            "MainWindow.LR0ParserMnemonic" ).charAt ( 0 ) );
    jMenuItemConvertToLR0Parser.setText ( bundle
        .getString ( "MainWindow.LR0Parser" ) ); // NOI18N
    jMenuItemConvertToLR0Parser
        .addActionListener ( new java.awt.event.ActionListener ()
        {
    ...
    jMenuItemConvertToLR1Parser.setMnemonic ( java.util.ResourceBundle
        .getBundle ( "de/unisiegen/gtitool/ui/i18n/messages" ).getString (
            "MainWindow.LR1ParserMnemonic" ).charAt ( 0 ) );
    jMenuItemConvertToLR1Parser.setText ( bundle
        .getString ( "MainWindow.LR1Parser" ) ); // NOI18N
    jMenuItemConvertToLR1Parser
        .addActionListener ( new java.awt.event.ActionListener ()
        {
    ...
    jMenuItemConvertToLALR1.setMnemonic ( java.util.ResourceBundle.getBundle (
        "de/unisiegen/gtitool/ui/i18n/messages" ).getString (
        "MainWindow.LALR1Mnemonic" ).charAt ( 0 ) );
    jMenuItemConvertToLALR1.setText ( bundle.getString ( "MainWindow.LALR1" ) ); // NOI18N
    jMenuItemConvertToLALR1
        .addActionListener ( new java.awt.event.ActionListener ()
        {
    ...
    jMenuItemConvertToLALR1Parser.setText ( bundle
        .getString ( "MainWindow.LALR1Parser" ) ); // NOI18N
    jMenuItemConvertToLALR1Parser.setToolTipText ( "" );
    jMenuItemConvertToLALR1Parser
        .addActionListener ( new java.awt.event.ActionListener ()
        {
    ...
    jMenuItemSLRParser.setMnemonic ( java.util.ResourceBundle.getBundle (
        "de/unisiegen/gtitool/ui/i18n/messages" ).getString (
        "MainWindow.SLRParserMnemonic" ).charAt ( 0 ) );
    ...
    jMenuConvertToComplete.setMnemonic ( java.util.ResourceBundle.getBundle (
        "de/unisiegen/gtitool/ui/i18n/messages" ).getString (
        "MainWindow.ConvertToCompleteMnemonic" ).charAt ( 0 ) );
    jMenuConvertToComplete.setText ( bundle
        .getString ( "MainWindow.ConvertToComplete" ) ); // NOI18N

    jMenuItemConvertToCompleteDFA.setText ( bundle
        .getString ( "MainWindow.DFA" ) ); // NOI18N
    jMenuItemConvertToCompleteDFA
        .addActionListener ( new java.awt.event.ActionListener ()
        {
    ...
    jMenuItemConvertToCompleteNFA.setText ( bundle
        .getString ( "MainWindow.NFA" ) ); // NOI18N
    jMenuItemConvertToCompleteNFA
        .addActionListener ( new java.awt.event.ActionListener ()
        {
    ...
    jMenuItemConvertToCompleteENFA.setText ( bundle
        .getString ( "MainWindow.ENFA" ) ); // NOI18N
    jMenuItemConvertToCompleteENFA
        .addActionListener ( new java.awt.event.ActionListener ()
        {
    ...
    jMenuItemConvertToCompletePDA.setText ( bundle
        .getString ( "MainWindow.PDA" ) ); // NOI18N
    jMenuItemConvertToCompletePDA
        .addActionListener ( new java.awt.event.ActionListener ()
        {
    ...
    jMenuDraft.setMnemonic ( java.util.ResourceBundle.getBundle (
        "de/unisiegen/gtitool/ui/i18n/messages" ).getString (
        "MainWindow.DraftForMnemonic" ).charAt ( 0 ) );
    ...
    jMenuItemAutoLayout.setMnemonic ( java.util.ResourceBundle.getBundle (
        "de/unisiegen/gtitool/ui/i18n/messages" ).getString (
        "MainWindow.AutoLayoutMnemonic" ).charAt ( 0 ) );
    ...
    jMenuItemMinimize.setMnemonic ( java.util.ResourceBundle.getBundle (
        "de/unisiegen/gtitool/ui/i18n/messages" ).getString (
        "MainWindow.MinimizeMnemonic" ).charAt ( 0 ) );
    ...
    jMenuItemToCoreSyntax.setMnemonic ( java.util.ResourceBundle.getBundle (
        "de/unisiegen/gtitool/ui/i18n/messages" ).getString (
        "MainWindow.ToCoreSyntaxMnemonic" ).charAt ( 0 ) );
    jMenuItemToCoreSyntax.setText ( bundle
        .getString ( "MainWindow.ToCoreSyntax" ) ); // NOI18N
    jMenuItemToCoreSyntax
        .addActionListener ( new java.awt.event.ActionListener ()
        {
    ...
    jMenuItemEliminateLeftRecursion.setMnemonic ( java.util.ResourceBundle
        .getBundle ( "de/unisiegen/gtitool/ui/i18n/messages" ).getString (
            "MainWindow.EliminateLeftRecursionMnemonic" ).charAt ( 0 ) );
    jMenuItemEliminateLeftRecursion.setText ( bundle
        .getString ( "MainWindow.EliminateLeftRecursion" ) ); // NOI18N
    jMenuItemEliminateLeftRecursion
        .addActionListener ( new java.awt.event.ActionListener ()
        {
    ...
    jMenuItemEliminateEntityProductions.setMnemonic ( java.util.ResourceBundle
        .getBundle ( "de/unisiegen/gtitool/ui/i18n/messages" ).getString (
            "MainWindow.EliminateEntityProductionsMnemonic" ).charAt ( 0 ) );
    jMenuItemEliminateEntityProductions.setText ( bundle
        .getString ( "MainWindow.EliminateEntityProductions" ) ); // NOI18N
    jMenuItemEliminateEntityProductions
        .addActionListener ( new java.awt.event.ActionListener ()
        {
    ...
    jMenuItemEliminateEpsilonProductions.setMnemonic ( java.util.ResourceBundle
        .getBundle ( "de/unisiegen/gtitool/ui/i18n/messages" ).getString (
            "MainWindow.EliminateEpsilonProductionsMnemonic" ).charAt ( 0 ) );
    jMenuItemEliminateEpsilonProductions.setText ( bundle
        .getString ( "MainWindow.EliminateEpsilonProductions" ) ); // NOI18N
    jMenuItemEliminateEpsilonProductions
        .addActionListener ( new java.awt.event.ActionListener ()
        {
    ...
    jMenuItemLeftfactoring.setMnemonic ( java.util.ResourceBundle.getBundle (
        "de/unisiegen/gtitool/ui/i18n/messages" ).getString (
        "MainWindow.LeftFactoringMnemonic" ).charAt ( 0 ) );
    jMenuItemLeftfactoring.setText ( bundle
        .getString ( "MainWindow.LeftFactoring" ) ); // NOI18N
    jMenuItemLeftfactoring
        .addActionListener ( new java.awt.event.ActionListener ()
        {
    ...
    jMenuItemCreateRDP.setMnemonic ( java.util.ResourceBundle.getBundle (
        "de/unisiegen/gtitool/ui/i18n/messages" ).getString (
        "MainWindow.CreateRDPMnemonic" ).charAt ( 0 ) );
    ...
    jMenuItemCreateTDP.setMnemonic ( java.util.ResourceBundle.getBundle (
        "de/unisiegen/gtitool/ui/i18n/messages" ).getString (
        "MainWindow.CreateTDPPDAMnemonic" ).charAt ( 0 ) );
    jMenuItemCreateTDP
        .setText ( bundle.getString ( "MainWindow.CreateTDPPDA" ) ); // NOI18N
    ...
    jMenuItemCreateParsingTableStepwise.setText ( bundle
        .getString ( "MainWindow.CreateParsingTableStepWise" ) ); // NOI18N
    jMenuItemCreateParsingTableStepwise.setToolTipText ( bundle
        .getString ( "MainWindow.CreateParsingTableStepWiseMnemonic" ) ); // NOI18N
    jMenuItemCreateParsingTableStepwise
        .addActionListener ( new java.awt.event.ActionListener ()
        {
    ...
    jMenuItemParsingTableFindEntries.setMnemonic ( java.util.ResourceBundle
        .getBundle ( "de/unisiegen/gtitool/ui/i18n/messages" ).getString (
            "MainWindow.ParsingTableFindEntriesMnemonic" ).charAt ( 0 ) );
    jMenuItemParsingTableFindEntries.setText ( bundle
        .getString ( "MainWindow.ParsingTableFindEntries" ) ); // NOI18N
    jMenuItemParsingTableFindEntries
        .addActionListener ( new java.awt.event.ActionListener ()
        {
    ...
    jMenuExtras.setMnemonic ( java.util.ResourceBundle.getBundle (
        "de/unisiegen/gtitool/ui/i18n/messages" ).getString (
        "MainWindow.ExtrasMnemonic" ).charAt ( 0 ) );
    jMenuExtras.setText ( bundle.getString ( "MainWindow.Extras" ) ); // NOI18N

    jMenuItemExchange.setMnemonic ( java.util.ResourceBundle.getBundle (
        "de/unisiegen/gtitool/ui/i18n/messages" ).getString (
        "MainWindow.Exchange" ).charAt ( 0 ) );
    ...
    jMenuItemHistory.setMnemonic ( java.util.ResourceBundle.getBundle (
        "de/unisiegen/gtitool/ui/i18n/messages" ).getString (
        "MainWindow.HistoryMnemonic" ).charAt ( 0 ) );
    ...
    jMenuItemReachableStates.setMnemonic ( java.util.ResourceBundle.getBundle (
        "de/unisiegen/gtitool/ui/i18n/messages" ).getString (
        "MainWindow.ReachableStatesMnemonic" ).charAt ( 0 ) );
    jMenuItemReachableStates.setText ( bundle
        .getString ( "MainWindow.ReachableStates" ) ); // NOI18N
    jMenuItemReachableStates
        .addActionListener ( new java.awt.event.ActionListener ()
        {
    ...
    jMenuItemReorderStateNames.setMnemonic ( java.util.ResourceBundle
        .getBundle ( "de/unisiegen/gtitool/ui/i18n/messages" ).getString (
            "MainWindow.ReorderStateNamesMnemonic" ).charAt ( 0 ) );
    jMenuItemReorderStateNames.setText ( bundle
        .getString ( "MainWindow.ReorderStateNames" ) ); // NOI18N
    jMenuItemReorderStateNames
        .addActionListener ( new java.awt.event.ActionListener ()
        {
    ...
    jMenuHelp.setMnemonic ( java.util.ResourceBundle.getBundle (
        "de/unisiegen/gtitool/ui/i18n/messages" ).getString (
        "MainWindow.HelpMnemonic" ).charAt ( 0 ) );
    ...
    jMenuItemAbout.setMnemonic ( java.util.ResourceBundle.getBundle (
        "de/unisiegen/gtitool/ui/i18n/messages" ).getString (
        "MainWindow.AboutMnemonic" ).charAt ( 0 ) );
  ...
  {// GEN-FIRST:event_jMenuItemParsingTableFindEntriesActionPerformed
  ...
  private void jMenuItemReorderStateNamesActionPerformed (
      java.awt.event.ActionEvent evt )
  {// GEN-FIRST:event_jMenuItemReorderStateNamesActionPerformed
    this.logic.handleReorderStateNames ();
  }// GEN-LAST:event_jMenuItemReorderStateNamesActionPerformed


  private void jMenuItemConvertToCompletePDAActionPerformed (
      java.awt.event.ActionEvent evt )
  {// GEN-FIRST:event_jMenuItemConvertToCompletePDAActionPerformed
    this.logic.handleConvertToComplete ( MachineType.PDA, false );
  }// GEN-LAST:event_jMenuItemConvertToCompletePDAActionPerformed


  private void jMenuItemConvertToCompleteENFAActionPerformed (
      java.awt.event.ActionEvent evt )
  {// GEN-FIRST:event_jMenuItemConvertToCompleteENFAActionPerformed
    this.logic.handleConvertToComplete ( MachineType.ENFA, false );
  }// GEN-LAST:event_jMenuItemConvertToCompleteENFAActionPerformed


  private void jMenuItemConvertToCompleteNFActionPerformed (
      java.awt.event.ActionEvent evt )
  {// GEN-FIRST:event_jMenuItemConvertToCompleteNFActionPerformed
    this.logic.handleConvertToComplete ( MachineType.NFA, false );
  }// GEN-LAST:event_jMenuItemConvertToCompleteNFActionPerformed


  private void jMenuItemConvertToCompleteDFAActionPerformed (
      java.awt.event.ActionEvent evt )
  {// GEN-FIRST:event_jMenuItemConvertToCompleteDFAActionPerformed
    this.logic.handleConvertToComplete ( MachineType.DFA, false );
  }// GEN-LAST:event_jMenuItemConvertToCompleteDFAActionPerformed


  private void jGTIToolBarToggleButtonEnterWordItemStateChanged (
      java.awt.event.ItemEvent evt )
  {// GEN-FIRST:event_jGTIToolBarToggleButtonEnterWordItemStateChanged
    this.logic.handleEnterWordToggleButton ();
  }// GEN-LAST:event_jGTIToolBarToggleButtonEnterWordItemStateChanged


  private void jMenuItemReachableStatesActionPerformed (
      java.awt.event.ActionEvent evt )
  {// GEN-FIRST:event_jMenuItemReachableStatesActionPerformed
    this.logic.handleReachableStates ();
  }// GEN-LAST:event_jMenuItemReachableStatesActionPerformed


  private void jGTIEditorPanelTabbedPaneRightStateChanged (
      javax.swing.event.ChangeEvent evt )
  {// GEN-FIRST:event_jGTIEditorPanelTabbedPaneRightStateChanged
    this.logic.handleTabbedPaneStateChanged ( evt );
  }// GEN-LAST:event_jGTIEditorPanelTabbedPaneRightStateChanged


  private void jGTIEditorPanelTabbedPaneRightMouseReleased (
      java.awt.event.MouseEvent evt )
  {// GEN-FIRST:event_jGTIEditorPanelTabbedPaneRightMouseReleased
    this.logic.handleTabbedPaneMouseReleased ( evt );
  }// GEN-LAST:event_jGTIEditorPanelTabbedPaneRightMouseReleased


  private void jCheckBoxMenuItemSecondViewItemStateChanged (
      java.awt.event.ItemEvent evt )
  {// GEN-FIRST:event_jCheckBoxMenuItemSecondViewItemStateChanged
    this.logic.handleSecondViewStateChanged ();
  }// GEN-LAST:event_jCheckBoxMenuItemSecondViewItemStateChanged


  private void jMenuItemMinimizeActionPerformed ( java.awt.event.ActionEvent evt )
  {// GEN-FIRST:event_jMenuItemMinimizeActionPerformed
    this.logic.handleMinimize ();
  }// GEN-LAST:event_jMenuItemMinimizeActionPerformed


  private void jMenuItemAutoLayoutActionPerformed (
      java.awt.event.ActionEvent evt )
  {// GEN-FIRST:event_jMenuItemAutoLayoutActionPerformed
  ...
  private void jMenuItemConvertToPDAActionPerformed (
      java.awt.event.ActionEvent evt )
  {// GEN-FIRST:event_jMenuItemConvertToPDAActionPerformed
    this.logic.handleConvertTo ( MachineType.PDA, false );
  }// GEN-LAST:event_jMenuItemConvertToPDAActionPerformed


  private void jMenuItemConvertToENFAActionPerformed (
      java.awt.event.ActionEvent evt )
  {// GEN-FIRST:event_jMenuItemConvertToENFAActionPerformed
    this.logic.handleConvertTo ( MachineType.ENFA, false );
  }// GEN-LAST:event_jMenuItemConvertToENFAActionPerformed


  private void jMenuItemConvertToNFActionPerformed (
      java.awt.event.ActionEvent evt )
  {// GEN-FIRST:event_jMenuItemConvertToNFActionPerformed
    this.logic.handleConvertTo ( MachineType.NFA, false );
  }// GEN-LAST:event_jMenuItemConvertToNFActionPerformed


  private void jMenuItemConvertToDFAActionPerformed (
      java.awt.event.ActionEvent evt )
  {// GEN-FIRST:event_jMenuItemConvertToDFAActionPerformed
    this.logic.handleConvertTo ( MachineType.DFA, false );
  }// GEN-LAST:event_jMenuItemConvertToDFAActionPerformed


  private void jGTIEditorPanelTabbedPaneLeftMouseReleased (
      java.awt.event.MouseEvent evt )
  {// GEN-FIRST:event_jGTIEditorPanelTabbedPaneLeftMouseReleased
    this.logic.handleTabbedPaneMouseReleased ( evt );
  }// GEN-LAST:event_jGTIEditorPanelTabbedPaneLeftMouseReleased


  private void jMenuItemHistoryActionPerformed ( java.awt.event.ActionEvent evt )
  {// GEN-FIRST:event_jMenuItemHistoryActionPerformed
    this.logic.handleHistory ();
  }// GEN-LAST:event_jMenuItemHistoryActionPerformed


  private void jMenuItemCFGhandleDraftFor ( java.awt.event.ActionEvent evt )
  {// GEN-FIRST:event_jMenuItemCFGhandleDraftFor
    this.logic.handleDraftFor ( GrammarType.CFG );
  }// GEN-LAST:event_jMenuItemCFGhandleDraftFor


  private void jMenuItemRGhandleDraftFor ( java.awt.event.ActionEvent evt )
  {// GEN-FIRST:event_jMenuItemRGhandleDraftFor
    this.logic.handleDraftFor ( GrammarType.RG );
  }// GEN-LAST:event_jMenuItemRGhandleDraftFor


  private void jGTIToolBarButtonAddProductionActionPerformed (
      java.awt.event.ActionEvent evt )
  {// GEN-FIRST:event_jGTIToolBarButtonAddProductionActionPerformed
  ...
  private void jGTIEditorPanelTabbedPaneLeftStateChanged (
      javax.swing.event.ChangeEvent evt )
  {// GEN-FIRST:event_jGTIEditorPanelTabbedPaneLeftStateChanged
    this.logic.handleTabbedPaneStateChanged ( evt );
  }// GEN-LAST:event_jGTIEditorPanelTabbedPaneLeftStateChanged


  private void jGTIToolBarToggleButtonFinalStateItemStateChanged (
      java.awt.event.ItemEvent evt )
  {// GEN-FIRST:event_jGTIToolBarToggleButtonFinalStateItemStateChanged
  ...
  private void jGTIToolBarToggleButtonStartStateItemStateChanged (
      java.awt.event.ItemEvent evt )
  {// GEN-FIRST:event_jGTIToolBarToggleButtonStartStateItemStateChanged
  ...
  private void jGTIToolBarToggleButtonAddTransitionItemStateChanged (
      java.awt.event.ItemEvent evt )
  {// GEN-FIRST:event_jGTIToolBarToggleButtonAddTransitionItemStateChanged
    this.logic
        .handleToolbarTransition ( this.jGTIToolBarToggleButtonAddTransition
            .isSelected () );
  }// GEN-LAST:event_jGTIToolBarToggleButtonAddTransitionItemStateChanged


  private void jGTIToolBarToggleButtonAutoStepItemStateChanged (
      java.awt.event.ItemEvent evt )
  {// GEN-FIRST:event_jGTIToolBarToggleButtonAutoStepItemStateChanged
    this.logic.handleWordAutoStep ( evt );
  }// GEN-LAST:event_jGTIToolBarToggleButtonAutoStepItemStateChanged


  private void jGTIToolBarToggleButtonAddStateItemStateChanged (
      java.awt.event.ItemEvent evt )
  {// GEN-FIRST:event_jGTIToolBarToggleButtonAddStateItemStateChanged
    this.logic.handleToolbarAddState ( this.jGTIToolBarToggleButtonAddState
        .isSelected () );
  }// GEN-LAST:event_jGTIToolBarToggleButtonAddStateItemStateChanged


  private void jGTIToolBarToggleButtonMouseItemStateChanged (
      java.awt.event.ItemEvent evt )
  {// GEN-FIRST:event_jGTIToolBarToggleButtonMouseItemStateChanged
    this.logic.handleToolbarMouse ( this.jGTIToolBarToggleButtonMouse
        .isSelected () );
  ...
  private void jGTIToolBarButtonStartActionPerformed (
      java.awt.event.ActionEvent evt )
  {// GEN-FIRST:event_jGTIToolBarButtonStartActionPerformed
    this.logic.handleWordStart ();
  }// GEN-LAST:event_jGTIToolBarButtonStartActionPerformed


  private void jGTIToolBarButtonEditDocumentActionPerformed (
      java.awt.event.ActionEvent evt )
  {// GEN-FIRST:event_jGTIToolBarButtonEditDocumentActionPerformed
    this.logic.handleEditDocument ();
  }// GEN-LAST:event_jGTIToolBarButtonEditDocumentActionPerformed


  private void jGTIToolBarButtonRedoActionPerformed (
      java.awt.event.ActionEvent evt )
  {// GEN-FIRST:event_jGTIToolBarButtonRedoActionPerformed
    this.logic.handleRedo ();
  }// GEN-LAST:event_jGTIToolBarButtonRedoActionPerformed


  private void jGTIToolBarButtonUndoActionPerformed (
      java.awt.event.ActionEvent evt )
  {// GEN-FIRST:event_jGTIToolBarButtonUndoActionPerformed
    this.logic.handleUndo ();
  }// GEN-LAST:event_jGTIToolBarButtonUndoActionPerformed


  private void jGTIToolBarButtonSaveActionPerformed (
      java.awt.event.ActionEvent evt )
  {// GEN-FIRST:event_jGTIToolBarButtonSaveActionPerformed
    this.logic.handleSave ();
  }// GEN-LAST:event_jGTIToolBarButtonSaveActionPerformed


  private void jGTIToolBarButtonSaveAsActionPerformed (
      java.awt.event.ActionEvent evt )
  {// GEN-FIRST:event_jGTIToolBarButtonSaveAsActionPerformed
    this.logic.handleSaveAs ();
  }// GEN-LAST:event_jGTIToolBarButtonSaveAsActionPerformed


  private void jGTIToolBarButtonOpenActionPerformed (
      java.awt.event.ActionEvent evt )
  {// GEN-FIRST:event_jGTIToolBarButtonOpenActionPerformed
    this.logic.handleOpen ();
  }// GEN-LAST:event_jGTIToolBarButtonOpenActionPerformed


  private void jGTIToolBarButtonNewActionPerformed (
      java.awt.event.ActionEvent evt )
  {// GEN-FIRST:event_jGTIToolBarButtonNewActionPerformed
    this.logic.handleNew ();
  }// GEN-LAST:event_jGTIToolBarButtonNewActionPerformed


  private void jMenuItemExchangeActionPerformed ( java.awt.event.ActionEvent evt )
  {// GEN-FIRST:event_jMenuItemExchangeActionPerformed
    this.logic.handleExchange ();
  }// GEN-LAST:event_jMenuItemExchangeActionPerformed


  private void jMenuItemDFAhandleDraftFor ( java.awt.event.ActionEvent evt )
  {// GEN-FIRST:event_jMenuItemDFAhandleDraftFor
    this.logic.handleDraftFor ( MachineType.DFA );
  }// GEN-LAST:event_jMenuItemDFAhandleDraftFor


  private void jMenuItemNFAhandleDraftFor ( java.awt.event.ActionEvent evt )
  {// GEN-FIRST:event_jMenuItemNFAhandleDraftFor
    this.logic.handleDraftFor ( MachineType.NFA );
  }// GEN-LAST:event_jMenuItemNFAhandleDraftFor


  private void jMenuItemPDAhandleDraftFor ( java.awt.event.ActionEvent evt )
  {// GEN-FIRST:event_jMenuItemPDAhandleDraftFor
    this.logic.handleDraftFor ( MachineType.PDA );
  }// GEN-LAST:event_jMenuItemPDAhandleDraftFor


  private void jMenuItemENFAhandleDraftFor ( java.awt.event.ActionEvent evt )
  {// GEN-FIRST:event_jMenuItemENFAhandleDraftFor
    this.logic.handleDraftFor ( MachineType.ENFA );
  }// GEN-LAST:event_jMenuItemENFAhandleDraftFor


  private void handleCloseAll ( java.awt.event.ActionEvent evt )
  {// GEN-FIRST:event_handleCloseAll
    this.logic.handleCloseAll ();
  }// GEN-LAST:event_handleCloseAll


  private void handleSaveAll ( java.awt.event.ActionEvent evt )
  {// GEN-FIRST:event_handleSaveAll
    this.logic.handleSaveAll ();
  }// GEN-LAST:event_handleSaveAll


  private void handleRedo ( java.awt.event.ActionEvent evt )
  {// GEN-FIRST:event_handleRedo
    this.logic.handleRedo ();
  }// GEN-LAST:event_handleRedo


  private void handleUndo ( java.awt.event.ActionEvent evt )
  {// GEN-FIRST:event_handleUndo
    this.logic.handleUndo ();
  }// GEN-LAST:event_handleUndo


  private void jMenuItemEditMachineActionPerformed (
      java.awt.event.ActionEvent evt )
  {// GEN-FIRST:event_jMenuItemEditMachineActionPerformed
    this.logic.handleEditMachine ();
  }// GEN-LAST:event_jMenuItemEditMachineActionPerformed


  private void handleClose ( java.awt.event.ActionEvent evt )
  {// GEN-FIRST:event_handleClose
    this.logic.handleClose ();
  }// GEN-LAST:event_handleClose


  private void jCheckBoxMenuItemTableItemStateChanged (
      java.awt.event.ItemEvent evt )
  {// GEN-FIRST:event_jCheckBoxMenuItemTableItemStateChanged
    this.logic.handleTableStateChanged ();
  }// GEN-LAST:event_jCheckBoxMenuItemTableItemStateChanged


  private void jCheckBoxMenuItemConsoleItemStateChanged (
      java.awt.event.ItemEvent evt )
  {// GEN-FIRST:event_jCheckBoxMenuItemConsoleItemStateChanged
    this.logic.handleConsoleStateChanged ();
  }// GEN-LAST:event_jCheckBoxMenuItemConsoleItemStateChanged


  private void handleSaveAs ( java.awt.event.ActionEvent evt )
  {// GEN-FIRST:event_handleSaveAs
    this.logic.handleSaveAs ();
  }// GEN-LAST:event_handleSaveAs


  private void handleSave ( java.awt.event.ActionEvent evt )
  {// GEN-FIRST:event_handleSave
    this.logic.handleSave ();
  }// GEN-LAST:event_handleSave


  private void jMenuItemValidateActionPerformed ( java.awt.event.ActionEvent evt )
  {// GEN-FIRST:event_jMenuItemValidateActionPerformed
    this.logic.handleValidate ();
  }// GEN-LAST:event_jMenuItemValidateActionPerformed


  private void jMenuItemEnterWordActionPerformed (
      java.awt.event.ActionEvent evt )
  {// GEN-FIRST:event_jMenuItemEnterWordActionPerformed
    this.logic.handleEnterWord ();
  }// GEN-LAST:event_jMenuItemEnterWordActionPerformed


  private void handleNew ( java.awt.event.ActionEvent evt )
  {// GEN-FIRST:event_handleNew
    this.logic.handleNew ();
  ...
  private void jMenuItemPreferencesActionPerformed (
      java.awt.event.ActionEvent evt )
  {// GEN-FIRST:event_jMenuItemPreferencesActionPerformed
    this.logic.handlePreferences ();
  }// GEN-LAST:event_jMenuItemPreferencesActionPerformed


  private void handleQuit ( java.awt.event.ActionEvent evt )
  {// GEN-FIRST:event_handleQuit
    this.logic.handleQuit ();
  }// GEN-LAST:event_handleQuit


  private void handleOpen ( java.awt.event.ActionEvent evt )
  {// GEN-FIRST:event_handleOpen
    this.logic.handleOpen ();
  }// GEN-LAST:event_handleOpen


  private void jMenuItemPrinthandleClose ( java.awt.event.ActionEvent evt )
  {// GEN-FIRST:event_jMenuItemPrinthandleClose
    this.logic.handlePrint ();
  }// GEN-LAST:event_jMenuItemPrinthandleClose


  private void jMenuItemExportPictureActionPerformed (
      java.awt.event.ActionEvent evt )
  {// GEN-FIRST:event_jMenuItemExportPictureActionPerformed
    this.logic.handleExportPicture ();
  }// GEN-LAST:event_jMenuItemExportPictureActionPerformed


  private void jMenuItemExportLatexActionPerformed (
      java.awt.event.ActionEvent evt )
  {// GEN-FIRST:event_jMenuItemExportLatexActionPerformed
    this.logic.handleToLatex ();
  }// GEN-LAST:event_jMenuItemExportLatexActionPerformed


  private void jMenuItemToCoreSyntaxActionPerformed (
      java.awt.event.ActionEvent evt )
  {// GEN-FIRST:event_jMenuItemToCoreSyntaxActionPerformed
    this.logic.handleToCoreSyntax ();
  }// GEN-LAST:event_jMenuItemToCoreSyntaxActionPerformed


  private void jCheckBoxMenuItemRegexInfoItemStateChanged (
      java.awt.event.ItemEvent evt )
  {// GEN-FIRST:event_jCheckBoxMenuItemRegexInfoItemStateChanged
    this.logic.handleRegexInfoChanged ( this.jCheckBoxMenuItemRegexInfo
        .isSelected () );
  }// GEN-LAST:event_jCheckBoxMenuItemRegexInfoItemStateChanged


  private void jMenuItemEliminateLeftRecursionActionPerformed (
      java.awt.event.ActionEvent evt )
  {// GEN-FIRST:event_jMenuItemEliminateLeftRecursionActionPerformed
  ...
  private void jMenuItemLeftfactoringActionPerformed (
      java.awt.event.ActionEvent evt )
  {// GEN-FIRST:event_jMenuItemLeftfactoringActionPerformed
    this.logic.handleLeftFactoring ();
  }// GEN-LAST:event_jMenuItemLeftfactoringActionPerformed


  private void jMenuItemConvertToRegexActionPerformed (
      java.awt.event.ActionEvent evt )
  {// GEN-FIRST:event_jMenuItemConvertToRegexActionPerformed
    this.logic.handleConvertTo ( RegexType.REGEX, false );
  }// GEN-LAST:event_jMenuItemConvertToRegexActionPerformed


  private void jMenuItemCreateRDPActionPerformed (
      java.awt.event.ActionEvent evt )
  {// GEN-FIRST:event_jMenuItemCreateRDPActionPerformed
  ...
  private void jMenuItemEliminateEntityProductionsActionPerformed (
      java.awt.event.ActionEvent evt )
  {// GEN-FIRST:event_jMenuItemEliminateEntityProductionsActionPerformed
    this.logic.handleEliminateEntityProductions ();
  }// GEN-LAST:event_jMenuItemEliminateEntityProductionsActionPerformed


  private void jMenuItemEliminateEpsilonProductionsActionPerformed (
      java.awt.event.ActionEvent evt )
  {// GEN-FIRST:event_jMenuItemEliminateEpsilonProductionsActionPerformed
    this.logic.handleEliminateEpsilonProductions ();
  }// GEN-LAST:event_jMenuItemEliminateEpsilonProductionsActionPerformed


  private void jMenuItemConvertToNFACBctionPerformed (
      java.awt.event.ActionEvent evt )
  {// GEN-FIRST:event_jMenuItemConvertToNFACBctionPerformed
    this.logic.handleConvertTo ( MachineType.NFA, true );
  }// GEN-LAST:event_jMenuItemConvertToNFACBctionPerformed


  private void jMenuItemCreateTDPActionPerformed (
      java.awt.event.ActionEvent evt )
  {// GEN-FIRST:event_jMenuItemCreateTDPActionPerformed
    this.logic.handleConvertTo ( MachineType.TDP, true );
  }// GEN-LAST:event_jMenuItemCreateTDPActionPerformed


  private void jMenuItemConvertToLR0ActionPerformed (
      java.awt.event.ActionEvent evt )
  {// GEN-FIRST:event_jMenuItemConvertToLR0ActionPerformed
    this.logic.handleConvertTo ( MachineType.LR0, true );
  }// GEN-LAST:event_jMenuItemConvertToLR0ActionPerformed


  private void jMenuItemConvertToLR1ActionPerformed (
      java.awt.event.ActionEvent evt )
  {// GEN-FIRST:event_jMenuItemConvertToLR1ActionPerformed
    this.logic.handleConvertTo ( MachineType.LR1, true );
  }// GEN-LAST:event_jMenuItemConvertToLR1ActionPerformed


  private void jMenuItemConvertToLR0ParserActionPerformed (
      java.awt.event.ActionEvent evt )
  {// GEN-FIRST:event_jMenuItemConvertToLR0ParserActionPerformed
    this.logic.handleConvertTo ( MachineType.LR0Parser, true );
  }// GEN-LAST:event_jMenuItemConvertToLR0ParserActionPerformed


  private void jMenuItemConvertToLR1ParserActionPerformed (
      java.awt.event.ActionEvent evt )
  {// GEN-FIRST:event_jMenuItemConvertToLR1ParserActionPerformed
    this.logic.handleConvertTo ( MachineType.LR1Parser, true );
  }// GEN-LAST:event_jMenuItemConvertToLR1ParserActionPerformed


  private void jMenuItemConvertToLALR1ActionPerformed (
      java.awt.event.ActionEvent evt )
  {// GEN-FIRST:event_jMenuItemConvertToLALR1ActionPerformed
    this.logic.handleConvertTo ( MachineType.LALR1, true );
  }// GEN-LAST:event_jMenuItemConvertToLALR1ActionPerformed


  private void jMenuItemConvertToLALR1ParserActionPerformed (
      java.awt.event.ActionEvent evt )
  {// GEN-FIRST:event_jMenuItemConvertToLALR1ParserActionPerformed
    this.logic.handleConvertTo ( MachineType.LALR1Parser, true );
  }// GEN-LAST:event_jMenuItemConvertToLALR1ParserActionPerformed


  private void jMenuItemSLRParserActionPerformed (
      java.awt.event.ActionEvent evt )
  {// GEN-FIRST:event_jMenuItemSLRParserActionPerformed
    this.logic.handleConvertTo ( MachineType.SLR, true );
  }// GEN-LAST:event_jMenuItemSLRParserActionPerformed


  private void jMenuItemCreateParsingTableStepwiseActionPerformed (
      java.awt.event.ActionEvent evt )
  {// GEN-FIRST:event_jMenuItemCreateParsingTableStepwiseActionPerformed
  ...
  private javax.swing.JMenuItem jMenuItemParsingTableFindEntries;
