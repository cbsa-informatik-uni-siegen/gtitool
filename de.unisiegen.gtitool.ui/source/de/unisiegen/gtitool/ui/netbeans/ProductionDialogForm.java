...
public class ProductionDialogForm extends JDialog implements GUIClass <ProductionDialog>
{
    ...
    */
    ...
    private void initComponents() {
        ...
        jGTIColumn1.setMinimumSize(new java.awt.Dimension(200, 16));
        jGTIColumn1.setPreferredSize(new java.awt.Dimension(200, 16));
        gridBagConstraints = new java.awt.GridBagConstraints();
        gridBagConstraints.gridx = 1;
        gridBagConstraints.gridy = 9;
        gridBagConstraints.fill = java.awt.GridBagConstraints.BOTH;
        gridBagConstraints.weightx = 1.0;
        getContentPane().add(jGTIColumn1, gridBagConstraints);
