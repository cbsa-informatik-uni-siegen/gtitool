...
public class StyledParserPanelBeanInfo extends SimpleBeanInfo
{
  ...
  private static BeanDescriptor getBdescriptor ()
  {
    BeanDescriptor beanDescriptor = new BeanDescriptor (
        de.unisiegen.gtitool.ui.style.parser.StyledParserPanel.class, null ); // NOI18N//GEN-HEADEREND:BeanDescriptor
  ...
  private static final int PROPERTY_copyable = 18;
  ...
  private static PropertyDescriptor [] getPdescriptor ()
  {
    ...
    try
    {
      properties [ PROPERTY_accessibleContext ] = new PropertyDescriptor (
          "accessibleContext",
          de.unisiegen.gtitool.ui.style.parser.StyledParserPanel.class,
      ...
      properties [ PROPERTY_component ] = new IndexedPropertyDescriptor (
          "component",
          de.unisiegen.gtitool.ui.style.parser.StyledParserPanel.class, null,
          null, "getComponent", null ); // NOI18N
      ...
      properties [ PROPERTY_copyable ] = new PropertyDescriptor ( "copyable",
          de.unisiegen.gtitool.ui.style.parser.StyledParserPanel.class,
          "isCopyable", "setCopyable" ); // NOI18N
      properties [ PROPERTY_copyable ].setDisplayName ( "copyable" );
      properties [ PROPERTY_copyable ]
          .setShortDescription ( "the copyable value" );
      ...
      properties [ PROPERTY_editable ] = new PropertyDescriptor ( "editable",
          de.unisiegen.gtitool.ui.style.parser.StyledParserPanel.class,
          "isEditable", "setEditable" ); // NOI18N
      properties [ PROPERTY_editable ].setDisplayName ( "editable" );
      properties [ PROPERTY_editable ]
          .setShortDescription ( "the editable value" );
      ...
      properties [ PROPERTY_focusTraversalKeys ] = new IndexedPropertyDescriptor (
          "focusTraversalKeys",
          de.unisiegen.gtitool.ui.style.parser.StyledParserPanel.class, null,
          null, "getFocusTraversalKeys", "setFocusTraversalKeys" ); // NOI18N
      ...
      properties [ PROPERTY_sideBarVisible ] = new PropertyDescriptor (
          "sideBarVisible",
          de.unisiegen.gtitool.ui.style.parser.StyledParserPanel.class,
          "isSideBarVisible", "setSideBarVisible" ); // NOI18N
      properties [ PROPERTY_sideBarVisible ].setDisplayName ( "sideBarVisible" );
      properties [ PROPERTY_sideBarVisible ]
          .setShortDescription ( "the sideBarVisible value" );
      ...
      properties [ PROPERTY_x ] = new PropertyDescriptor ( "x",
          de.unisiegen.gtitool.ui.style.parser.StyledParserPanel.class, "getX",
          null ); // NOI18N
      properties [ PROPERTY_y ] = new PropertyDescriptor ( "y",
          de.unisiegen.gtitool.ui.style.parser.StyledParserPanel.class, "getY",
          null ); // NOI18N
    }
  ...
  private static EventSetDescriptor [] getEdescriptor ()
  {
    ...
    try
    {
      eventSets [ EVENT_ancestorListener ] = new EventSetDescriptor (
          de.unisiegen.gtitool.ui.style.parser.StyledParserPanel.class,
          "ancestorListener", javax.swing.event.AncestorListener.class,
          new String []
      ...
      eventSets [ EVENT_componentListener ] = new EventSetDescriptor (
          ...
          { "componentHidden", "componentMoved", "componentResized",
              "componentShown" }, "addComponentListener",
      ...
      eventSets [ EVENT_containerListener ] = new EventSetDescriptor (
          ...
          new String []
          { "componentAdded", "componentRemoved" }, "addContainerListener",
          "removeContainerListener" ); // NOI18N
      eventSets [ EVENT_focusListener ] = new EventSetDescriptor (
          de.unisiegen.gtitool.ui.style.parser.StyledParserPanel.class,
          "focusListener", java.awt.event.FocusListener.class, new String []
          { "focusGained", "focusLost" }, "addFocusListener",
      ...
      eventSets [ EVENT_hierarchyListener ] = new EventSetDescriptor (
          ...
          new String []
          { "hierarchyChanged" }, "addHierarchyListener",
      ...
      eventSets [ EVENT_keyListener ] = new EventSetDescriptor (
          de.unisiegen.gtitool.ui.style.parser.StyledParserPanel.class,
          "keyListener", java.awt.event.KeyListener.class, new String []
          { "keyPressed", "keyReleased", "keyTyped" }, "addKeyListener",
          "removeKeyListener" ); // NOI18N
      eventSets [ EVENT_mouseListener ] = new EventSetDescriptor (
          de.unisiegen.gtitool.ui.style.parser.StyledParserPanel.class,
          "mouseListener", java.awt.event.MouseListener.class, new String []
          { "mouseClicked", "mouseEntered", "mouseExited", "mousePressed",
              "mouseReleased" }, "addMouseListener", "removeMouseListener" ); // NOI18N
      eventSets [ EVENT_mouseMotionListener ] = new EventSetDescriptor (
          de.unisiegen.gtitool.ui.style.parser.StyledParserPanel.class,
          "mouseMotionListener", java.awt.event.MouseMotionListener.class,
          new String []
          { "mouseDragged", "mouseMoved" }, "addMouseMotionListener",
      ...
      eventSets [ EVENT_mouseWheelListener ] = new EventSetDescriptor (
          ...
          new String []
          { "mouseWheelMoved" }, "addMouseWheelListener",
      ...
      eventSets [ EVENT_vetoableChangeListener ] = new EventSetDescriptor (
          ...
          new String []
          { "vetoableChange" }, "addVetoableChangeListener",
  ...
  private static MethodDescriptor [] getMdescriptor ()
  {
    ...
    try
    {
      methods [ METHOD_action0 ] = new MethodDescriptor (
          de.unisiegen.gtitool.ui.style.parser.StyledParserPanel.class
      ...
      methods [ METHOD_addNotify2 ] = new MethodDescriptor (
          de.unisiegen.gtitool.ui.style.parser.StyledParserPanel.class
              .getMethod ( "addNotify", new Class [] {} ) ); // NOI18N
      ...
      methods [ METHOD_applyComponentOrientation4 ] = new MethodDescriptor (
          de.unisiegen.gtitool.ui.style.parser.StyledParserPanel.class
              .getMethod ( "applyComponentOrientation", new Class []
              { java.awt.ComponentOrientation.class } ) ); // NOI18N
      methods [ METHOD_applyComponentOrientation4 ].setDisplayName ( "" );
      methods [ METHOD_areFocusTraversalKeysSet5 ] = new MethodDescriptor (
          de.unisiegen.gtitool.ui.style.parser.StyledParserPanel.class
              .getMethod ( "areFocusTraversalKeysSet", new Class []
              { Integer.TYPE } ) ); // NOI18N
      methods [ METHOD_areFocusTraversalKeysSet5 ].setDisplayName ( "" );
      methods [ METHOD_bounds6 ] = new MethodDescriptor (
          de.unisiegen.gtitool.ui.style.parser.StyledParserPanel.class
              .getMethod ( "bounds", new Class [] {} ) ); // NOI18N
      methods [ METHOD_bounds6 ].setDisplayName ( "" );
      methods [ METHOD_checkImage7 ] = new MethodDescriptor (
          de.unisiegen.gtitool.ui.style.parser.StyledParserPanel.class
      ...
      methods [ METHOD_computeVisibleRect8 ] = new MethodDescriptor (
          de.unisiegen.gtitool.ui.style.parser.StyledParserPanel.class
              .getMethod ( "computeVisibleRect", new Class []
              { java.awt.Rectangle.class } ) ); // NOI18N
      methods [ METHOD_computeVisibleRect8 ].setDisplayName ( "" );
      methods [ METHOD_contains9 ] = new MethodDescriptor (
          de.unisiegen.gtitool.ui.style.parser.StyledParserPanel.class
              .getMethod ( "contains", new Class []
              { Integer.TYPE, Integer.TYPE } ) ); // NOI18N
      methods [ METHOD_contains9 ].setDisplayName ( "" );
      methods [ METHOD_countComponents10 ] = new MethodDescriptor (
          de.unisiegen.gtitool.ui.style.parser.StyledParserPanel.class
              .getMethod ( "countComponents", new Class [] {} ) ); // NOI18N
      methods [ METHOD_countComponents10 ].setDisplayName ( "" );
      methods [ METHOD_createImage11 ] = new MethodDescriptor (
          de.unisiegen.gtitool.ui.style.parser.StyledParserPanel.class
              .getMethod ( "createImage", new Class []
              { java.awt.image.ImageProducer.class } ) ); // NOI18N
      methods [ METHOD_createImage11 ].setDisplayName ( "" );
      methods [ METHOD_createToolTip12 ] = new MethodDescriptor (
          de.unisiegen.gtitool.ui.style.parser.StyledParserPanel.class
              .getMethod ( "createToolTip", new Class [] {} ) ); // NOI18N
      methods [ METHOD_createToolTip12 ].setDisplayName ( "" );
      methods [ METHOD_createVolatileImage13 ] = new MethodDescriptor (
          de.unisiegen.gtitool.ui.style.parser.StyledParserPanel.class
              .getMethod ( "createVolatileImage", new Class []
              { Integer.TYPE, Integer.TYPE } ) ); // NOI18N
      methods [ METHOD_createVolatileImage13 ].setDisplayName ( "" );
      methods [ METHOD_deliverEvent14 ] = new MethodDescriptor (
          de.unisiegen.gtitool.ui.style.parser.StyledParserPanel.class
              .getMethod ( "deliverEvent", new Class []
              { java.awt.Event.class } ) ); // NOI18N
      methods [ METHOD_deliverEvent14 ].setDisplayName ( "" );
      methods [ METHOD_disable15 ] = new MethodDescriptor (
          de.unisiegen.gtitool.ui.style.parser.StyledParserPanel.class
              .getMethod ( "disable", new Class [] {} ) ); // NOI18N
      methods [ METHOD_disable15 ].setDisplayName ( "" );
      methods [ METHOD_dispatchEvent16 ] = new MethodDescriptor (
          de.unisiegen.gtitool.ui.style.parser.StyledParserPanel.class
              .getMethod ( "dispatchEvent", new Class []
              { java.awt.AWTEvent.class } ) ); // NOI18N
      methods [ METHOD_dispatchEvent16 ].setDisplayName ( "" );
      methods [ METHOD_doLayout17 ] = new MethodDescriptor (
          de.unisiegen.gtitool.ui.style.parser.StyledParserPanel.class
              .getMethod ( "doLayout", new Class [] {} ) ); // NOI18N
      methods [ METHOD_doLayout17 ].setDisplayName ( "" );
      methods [ METHOD_enable18 ] = new MethodDescriptor (
          de.unisiegen.gtitool.ui.style.parser.StyledParserPanel.class
              .getMethod ( "enable", new Class [] {} ) ); // NOI18N
      methods [ METHOD_enable18 ].setDisplayName ( "" );
      methods [ METHOD_enableInputMethods19 ] = new MethodDescriptor (
          de.unisiegen.gtitool.ui.style.parser.StyledParserPanel.class
              .getMethod ( "enableInputMethods", new Class []
              { Boolean.TYPE } ) ); // NOI18N
      methods [ METHOD_enableInputMethods19 ].setDisplayName ( "" );
      methods [ METHOD_findComponentAt20 ] = new MethodDescriptor (
          de.unisiegen.gtitool.ui.style.parser.StyledParserPanel.class
              .getMethod ( "findComponentAt", new Class []
              { Integer.TYPE, Integer.TYPE } ) ); // NOI18N
      methods [ METHOD_findComponentAt20 ].setDisplayName ( "" );
      methods [ METHOD_firePropertyChange21 ] = new MethodDescriptor (
          de.unisiegen.gtitool.ui.style.parser.StyledParserPanel.class
              .getMethod ( "firePropertyChange", new Class []
              { java.lang.String.class, Boolean.TYPE, Boolean.TYPE } ) ); // NOI18N
      methods [ METHOD_firePropertyChange21 ].setDisplayName ( "" );
      methods [ METHOD_getActionForKeyStroke22 ] = new MethodDescriptor (
          de.unisiegen.gtitool.ui.style.parser.StyledParserPanel.class
              .getMethod ( "getActionForKeyStroke", new Class []
              { javax.swing.KeyStroke.class } ) ); // NOI18N
      methods [ METHOD_getActionForKeyStroke22 ].setDisplayName ( "" );
      methods [ METHOD_getBounds23 ] = new MethodDescriptor (
          de.unisiegen.gtitool.ui.style.parser.StyledParserPanel.class
              .getMethod ( "getBounds", new Class []
              { java.awt.Rectangle.class } ) ); // NOI18N
      methods [ METHOD_getBounds23 ].setDisplayName ( "" );
      methods [ METHOD_getClientProperty24 ] = new MethodDescriptor (
          de.unisiegen.gtitool.ui.style.parser.StyledParserPanel.class
              .getMethod ( "getClientProperty", new Class []
              { java.lang.Object.class } ) ); // NOI18N
      methods [ METHOD_getClientProperty24 ].setDisplayName ( "" );
      methods [ METHOD_getComponentAt25 ] = new MethodDescriptor (
          de.unisiegen.gtitool.ui.style.parser.StyledParserPanel.class
              .getMethod ( "getComponentAt", new Class []
              { Integer.TYPE, Integer.TYPE } ) ); // NOI18N
      methods [ METHOD_getComponentAt25 ].setDisplayName ( "" );
      methods [ METHOD_getComponentZOrder26 ] = new MethodDescriptor (
          de.unisiegen.gtitool.ui.style.parser.StyledParserPanel.class
              .getMethod ( "getComponentZOrder", new Class []
              { java.awt.Component.class } ) ); // NOI18N
      methods [ METHOD_getComponentZOrder26 ].setDisplayName ( "" );
      methods [ METHOD_getConditionForKeyStroke27 ] = new MethodDescriptor (
          de.unisiegen.gtitool.ui.style.parser.StyledParserPanel.class
              .getMethod ( "getConditionForKeyStroke", new Class []
              { javax.swing.KeyStroke.class } ) ); // NOI18N
      methods [ METHOD_getConditionForKeyStroke27 ].setDisplayName ( "" );
      methods [ METHOD_getDefaultLocale28 ] = new MethodDescriptor (
          de.unisiegen.gtitool.ui.style.parser.StyledParserPanel.class
              .getMethod ( "getDefaultLocale", new Class [] {} ) ); // NOI18N
      methods [ METHOD_getDefaultLocale28 ].setDisplayName ( "" );
      methods [ METHOD_getFontMetrics29 ] = new MethodDescriptor (
          de.unisiegen.gtitool.ui.style.parser.StyledParserPanel.class
              .getMethod ( "getFontMetrics", new Class []
              { java.awt.Font.class } ) ); // NOI18N
      methods [ METHOD_getFontMetrics29 ].setDisplayName ( "" );
      methods [ METHOD_getInsets30 ] = new MethodDescriptor (
          de.unisiegen.gtitool.ui.style.parser.StyledParserPanel.class
              .getMethod ( "getInsets", new Class []
              { java.awt.Insets.class } ) ); // NOI18N
      methods [ METHOD_getInsets30 ].setDisplayName ( "" );
      methods [ METHOD_getListeners31 ] = new MethodDescriptor (
          de.unisiegen.gtitool.ui.style.parser.StyledParserPanel.class
              .getMethod ( "getListeners", new Class []
              { java.lang.Class.class } ) ); // NOI18N
      methods [ METHOD_getListeners31 ].setDisplayName ( "" );
      methods [ METHOD_getLocation32 ] = new MethodDescriptor (
          de.unisiegen.gtitool.ui.style.parser.StyledParserPanel.class
              .getMethod ( "getLocation", new Class []
              { java.awt.Point.class } ) ); // NOI18N
      methods [ METHOD_getLocation32 ].setDisplayName ( "" );
      methods [ METHOD_getMousePosition33 ] = new MethodDescriptor (
          de.unisiegen.gtitool.ui.style.parser.StyledParserPanel.class
              .getMethod ( "getMousePosition", new Class []
              { Boolean.TYPE } ) ); // NOI18N
      methods [ METHOD_getMousePosition33 ].setDisplayName ( "" );
      methods [ METHOD_getPopupLocation34 ] = new MethodDescriptor (
          de.unisiegen.gtitool.ui.style.parser.StyledParserPanel.class
              .getMethod ( "getPopupLocation", new Class []
              { java.awt.event.MouseEvent.class } ) ); // NOI18N
      methods [ METHOD_getPopupLocation34 ].setDisplayName ( "" );
      methods [ METHOD_getPropertyChangeListeners35 ] = new MethodDescriptor (
          de.unisiegen.gtitool.ui.style.parser.StyledParserPanel.class
              .getMethod ( "getPropertyChangeListeners", new Class []
              { java.lang.String.class } ) ); // NOI18N
      methods [ METHOD_getPropertyChangeListeners35 ].setDisplayName ( "" );
      methods [ METHOD_getSize36 ] = new MethodDescriptor (
          de.unisiegen.gtitool.ui.style.parser.StyledParserPanel.class
              .getMethod ( "getSize", new Class []
              { java.awt.Dimension.class } ) ); // NOI18N
      methods [ METHOD_getSize36 ].setDisplayName ( "" );
      methods [ METHOD_getToolTipLocation37 ] = new MethodDescriptor (
          de.unisiegen.gtitool.ui.style.parser.StyledParserPanel.class
              .getMethod ( "getToolTipLocation", new Class []
              { java.awt.event.MouseEvent.class } ) ); // NOI18N
      methods [ METHOD_getToolTipLocation37 ].setDisplayName ( "" );
      methods [ METHOD_getToolTipText38 ] = new MethodDescriptor (
          de.unisiegen.gtitool.ui.style.parser.StyledParserPanel.class
              .getMethod ( "getToolTipText", new Class []
              { java.awt.event.MouseEvent.class } ) ); // NOI18N
      methods [ METHOD_getToolTipText38 ].setDisplayName ( "" );
      methods [ METHOD_gotFocus39 ] = new MethodDescriptor (
          de.unisiegen.gtitool.ui.style.parser.StyledParserPanel.class
              .getMethod ( "gotFocus", new Class []
              { java.awt.Event.class, java.lang.Object.class } ) ); // NOI18N
      methods [ METHOD_gotFocus39 ].setDisplayName ( "" );
      methods [ METHOD_grabFocus40 ] = new MethodDescriptor (
          de.unisiegen.gtitool.ui.style.parser.StyledParserPanel.class
              .getMethod ( "grabFocus", new Class [] {} ) ); // NOI18N
      methods [ METHOD_grabFocus40 ].setDisplayName ( "" );
      methods [ METHOD_handleEvent41 ] = new MethodDescriptor (
          de.unisiegen.gtitool.ui.style.parser.StyledParserPanel.class
              .getMethod ( "handleEvent", new Class []
              { java.awt.Event.class } ) ); // NOI18N
      methods [ METHOD_handleEvent41 ].setDisplayName ( "" );
      methods [ METHOD_hasFocus42 ] = new MethodDescriptor (
          de.unisiegen.gtitool.ui.style.parser.StyledParserPanel.class
              .getMethod ( "hasFocus", new Class [] {} ) ); // NOI18N
      methods [ METHOD_hasFocus42 ].setDisplayName ( "" );
      methods [ METHOD_hide43 ] = new MethodDescriptor (
          de.unisiegen.gtitool.ui.style.parser.StyledParserPanel.class
              .getMethod ( "hide", new Class [] {} ) ); // NOI18N
      methods [ METHOD_hide43 ].setDisplayName ( "" );
      methods [ METHOD_imageUpdate44 ] = new MethodDescriptor (
          de.unisiegen.gtitool.ui.style.parser.StyledParserPanel.class
              .getMethod ( "imageUpdate", new Class []
              { java.awt.Image.class, Integer.TYPE, Integer.TYPE, Integer.TYPE,
                  Integer.TYPE, Integer.TYPE } ) ); // NOI18N
      methods [ METHOD_imageUpdate44 ].setDisplayName ( "" );
      methods [ METHOD_insets45 ] = new MethodDescriptor (
          de.unisiegen.gtitool.ui.style.parser.StyledParserPanel.class
              .getMethod ( "insets", new Class [] {} ) ); // NOI18N
      methods [ METHOD_insets45 ].setDisplayName ( "" );
      methods [ METHOD_inside46 ] = new MethodDescriptor (
          de.unisiegen.gtitool.ui.style.parser.StyledParserPanel.class
              .getMethod ( "inside", new Class []
              { Integer.TYPE, Integer.TYPE } ) ); // NOI18N
      methods [ METHOD_inside46 ].setDisplayName ( "" );
      methods [ METHOD_invalidate47 ] = new MethodDescriptor (
          de.unisiegen.gtitool.ui.style.parser.StyledParserPanel.class
              .getMethod ( "invalidate", new Class [] {} ) ); // NOI18N
      methods [ METHOD_invalidate47 ].setDisplayName ( "" );
      methods [ METHOD_isAncestorOf48 ] = new MethodDescriptor (
          de.unisiegen.gtitool.ui.style.parser.StyledParserPanel.class
              .getMethod ( "isAncestorOf", new Class []
              { java.awt.Component.class } ) ); // NOI18N
      methods [ METHOD_isAncestorOf48 ].setDisplayName ( "" );
      methods [ METHOD_isFocusCycleRoot49 ] = new MethodDescriptor (
          de.unisiegen.gtitool.ui.style.parser.StyledParserPanel.class
              .getMethod ( "isFocusCycleRoot", new Class []
              { java.awt.Container.class } ) ); // NOI18N
      methods [ METHOD_isFocusCycleRoot49 ].setDisplayName ( "" );
      methods [ METHOD_isLightweightComponent50 ] = new MethodDescriptor (
          de.unisiegen.gtitool.ui.style.parser.StyledParserPanel.class
              .getMethod ( "isLightweightComponent", new Class []
              { java.awt.Component.class } ) ); // NOI18N
      methods [ METHOD_isLightweightComponent50 ].setDisplayName ( "" );
      methods [ METHOD_keyDown51 ] = new MethodDescriptor (
          de.unisiegen.gtitool.ui.style.parser.StyledParserPanel.class
              .getMethod ( "keyDown", new Class []
              { java.awt.Event.class, Integer.TYPE } ) ); // NOI18N
      methods [ METHOD_keyDown51 ].setDisplayName ( "" );
      methods [ METHOD_keyUp52 ] = new MethodDescriptor (
          de.unisiegen.gtitool.ui.style.parser.StyledParserPanel.class
              .getMethod ( "keyUp", new Class []
              { java.awt.Event.class, Integer.TYPE } ) ); // NOI18N
      methods [ METHOD_keyUp52 ].setDisplayName ( "" );
      methods [ METHOD_layout53 ] = new MethodDescriptor (
          de.unisiegen.gtitool.ui.style.parser.StyledParserPanel.class
              .getMethod ( "layout", new Class [] {} ) ); // NOI18N
      methods [ METHOD_layout53 ].setDisplayName ( "" );
      methods [ METHOD_list54 ] = new MethodDescriptor (
          de.unisiegen.gtitool.ui.style.parser.StyledParserPanel.class
              .getMethod ( "list", new Class []
              { java.io.PrintStream.class, Integer.TYPE } ) ); // NOI18N
      methods [ METHOD_list54 ].setDisplayName ( "" );
      methods [ METHOD_locate55 ] = new MethodDescriptor (
          de.unisiegen.gtitool.ui.style.parser.StyledParserPanel.class
              .getMethod ( "locate", new Class []
              { Integer.TYPE, Integer.TYPE } ) ); // NOI18N
      methods [ METHOD_locate55 ].setDisplayName ( "" );
      methods [ METHOD_location56 ] = new MethodDescriptor (
          de.unisiegen.gtitool.ui.style.parser.StyledParserPanel.class
              .getMethod ( "location", new Class [] {} ) ); // NOI18N
      methods [ METHOD_location56 ].setDisplayName ( "" );
      methods [ METHOD_lostFocus57 ] = new MethodDescriptor (
          de.unisiegen.gtitool.ui.style.parser.StyledParserPanel.class
              .getMethod ( "lostFocus", new Class []
              { java.awt.Event.class, java.lang.Object.class } ) ); // NOI18N
      methods [ METHOD_lostFocus57 ].setDisplayName ( "" );
      methods [ METHOD_minimumSize58 ] = new MethodDescriptor (
          de.unisiegen.gtitool.ui.style.parser.StyledParserPanel.class
              .getMethod ( "minimumSize", new Class [] {} ) ); // NOI18N
      methods [ METHOD_minimumSize58 ].setDisplayName ( "" );
      methods [ METHOD_mouseDown59 ] = new MethodDescriptor (
          de.unisiegen.gtitool.ui.style.parser.StyledParserPanel.class
              .getMethod ( "mouseDown", new Class []
              { java.awt.Event.class, Integer.TYPE, Integer.TYPE } ) ); // NOI18N
      methods [ METHOD_mouseDown59 ].setDisplayName ( "" );
      methods [ METHOD_mouseDrag60 ] = new MethodDescriptor (
          de.unisiegen.gtitool.ui.style.parser.StyledParserPanel.class
              .getMethod ( "mouseDrag", new Class []
              { java.awt.Event.class, Integer.TYPE, Integer.TYPE } ) ); // NOI18N
      methods [ METHOD_mouseDrag60 ].setDisplayName ( "" );
      methods [ METHOD_mouseEnter61 ] = new MethodDescriptor (
          de.unisiegen.gtitool.ui.style.parser.StyledParserPanel.class
              .getMethod ( "mouseEnter", new Class []
              { java.awt.Event.class, Integer.TYPE, Integer.TYPE } ) ); // NOI18N
      methods [ METHOD_mouseEnter61 ].setDisplayName ( "" );
      methods [ METHOD_mouseExit62 ] = new MethodDescriptor (
          de.unisiegen.gtitool.ui.style.parser.StyledParserPanel.class
              .getMethod ( "mouseExit", new Class []
              { java.awt.Event.class, Integer.TYPE, Integer.TYPE } ) ); // NOI18N
      methods [ METHOD_mouseExit62 ].setDisplayName ( "" );
      methods [ METHOD_mouseMove63 ] = new MethodDescriptor (
          de.unisiegen.gtitool.ui.style.parser.StyledParserPanel.class
              .getMethod ( "mouseMove", new Class []
              { java.awt.Event.class, Integer.TYPE, Integer.TYPE } ) ); // NOI18N
      methods [ METHOD_mouseMove63 ].setDisplayName ( "" );
      methods [ METHOD_mouseUp64 ] = new MethodDescriptor (
          de.unisiegen.gtitool.ui.style.parser.StyledParserPanel.class
              .getMethod ( "mouseUp", new Class []
              { java.awt.Event.class, Integer.TYPE, Integer.TYPE } ) ); // NOI18N
      methods [ METHOD_mouseUp64 ].setDisplayName ( "" );
      methods [ METHOD_move65 ] = new MethodDescriptor (
          de.unisiegen.gtitool.ui.style.parser.StyledParserPanel.class
              .getMethod ( "move", new Class []
              { Integer.TYPE, Integer.TYPE } ) ); // NOI18N
      methods [ METHOD_move65 ].setDisplayName ( "" );
      methods [ METHOD_nextFocus66 ] = new MethodDescriptor (
          de.unisiegen.gtitool.ui.style.parser.StyledParserPanel.class
              .getMethod ( "nextFocus", new Class [] {} ) ); // NOI18N
      methods [ METHOD_nextFocus66 ].setDisplayName ( "" );
      methods [ METHOD_paint67 ] = new MethodDescriptor (
          de.unisiegen.gtitool.ui.style.parser.StyledParserPanel.class
              .getMethod ( "paint", new Class []
              { java.awt.Graphics.class } ) ); // NOI18N
      methods [ METHOD_paint67 ].setDisplayName ( "" );
      methods [ METHOD_paintAll68 ] = new MethodDescriptor (
          de.unisiegen.gtitool.ui.style.parser.StyledParserPanel.class
              .getMethod ( "paintAll", new Class []
              { java.awt.Graphics.class } ) ); // NOI18N
      methods [ METHOD_paintAll68 ].setDisplayName ( "" );
      methods [ METHOD_paintComponents69 ] = new MethodDescriptor (
          de.unisiegen.gtitool.ui.style.parser.StyledParserPanel.class
              .getMethod ( "paintComponents", new Class []
              { java.awt.Graphics.class } ) ); // NOI18N
      methods [ METHOD_paintComponents69 ].setDisplayName ( "" );
      methods [ METHOD_paintImmediately70 ] = new MethodDescriptor (
          de.unisiegen.gtitool.ui.style.parser.StyledParserPanel.class
              .getMethod ( "paintImmediately", new Class []
              { Integer.TYPE, Integer.TYPE, Integer.TYPE, Integer.TYPE } ) ); // NOI18N
      methods [ METHOD_paintImmediately70 ].setDisplayName ( "" );
      methods [ METHOD_postEvent71 ] = new MethodDescriptor (
          de.unisiegen.gtitool.ui.style.parser.StyledParserPanel.class
              .getMethod ( "postEvent", new Class []
              { java.awt.Event.class } ) ); // NOI18N
      methods [ METHOD_postEvent71 ].setDisplayName ( "" );
      methods [ METHOD_preferredSize72 ] = new MethodDescriptor (
          de.unisiegen.gtitool.ui.style.parser.StyledParserPanel.class
              .getMethod ( "preferredSize", new Class [] {} ) ); // NOI18N
      methods [ METHOD_preferredSize72 ].setDisplayName ( "" );
      methods [ METHOD_prepareImage73 ] = new MethodDescriptor (
          de.unisiegen.gtitool.ui.style.parser.StyledParserPanel.class
              .getMethod ( "prepareImage", new Class []
              { java.awt.Image.class, java.awt.image.ImageObserver.class } ) ); // NOI18N
      methods [ METHOD_prepareImage73 ].setDisplayName ( "" );
      methods [ METHOD_print74 ] = new MethodDescriptor (
          de.unisiegen.gtitool.ui.style.parser.StyledParserPanel.class
              .getMethod ( "print", new Class []
              { java.awt.Graphics.class } ) ); // NOI18N
      methods [ METHOD_print74 ].setDisplayName ( "" );
      methods [ METHOD_printAll75 ] = new MethodDescriptor (
          de.unisiegen.gtitool.ui.style.parser.StyledParserPanel.class
              .getMethod ( "printAll", new Class []
              { java.awt.Graphics.class } ) ); // NOI18N
      methods [ METHOD_printAll75 ].setDisplayName ( "" );
      methods [ METHOD_printComponents76 ] = new MethodDescriptor (
          de.unisiegen.gtitool.ui.style.parser.StyledParserPanel.class
              .getMethod ( "printComponents", new Class []
              { java.awt.Graphics.class } ) ); // NOI18N
      methods [ METHOD_printComponents76 ].setDisplayName ( "" );
      methods [ METHOD_putClientProperty77 ] = new MethodDescriptor (
          de.unisiegen.gtitool.ui.style.parser.StyledParserPanel.class
              .getMethod ( "putClientProperty", new Class []
              { java.lang.Object.class, java.lang.Object.class } ) ); // NOI18N
      methods [ METHOD_putClientProperty77 ].setDisplayName ( "" );
      methods [ METHOD_registerKeyboardAction78 ] = new MethodDescriptor (
          de.unisiegen.gtitool.ui.style.parser.StyledParserPanel.class
              .getMethod ( "registerKeyboardAction", new Class []
              { java.awt.event.ActionListener.class, java.lang.String.class,
                  javax.swing.KeyStroke.class, Integer.TYPE } ) ); // NOI18N
      methods [ METHOD_registerKeyboardAction78 ].setDisplayName ( "" );
      methods [ METHOD_remove79 ] = new MethodDescriptor (
          de.unisiegen.gtitool.ui.style.parser.StyledParserPanel.class
              .getMethod ( "remove", new Class []
              { Integer.TYPE } ) ); // NOI18N
      methods [ METHOD_remove79 ].setDisplayName ( "" );
      methods [ METHOD_removeAll80 ] = new MethodDescriptor (
          de.unisiegen.gtitool.ui.style.parser.StyledParserPanel.class
              .getMethod ( "removeAll", new Class [] {} ) ); // NOI18N
      methods [ METHOD_removeAll80 ].setDisplayName ( "" );
      methods [ METHOD_removeNotify81 ] = new MethodDescriptor (
          de.unisiegen.gtitool.ui.style.parser.StyledParserPanel.class
              .getMethod ( "removeNotify", new Class [] {} ) ); // NOI18N
      methods [ METHOD_removeNotify81 ].setDisplayName ( "" );
      methods [ METHOD_removePropertyChangeListener82 ] = new MethodDescriptor (
          de.unisiegen.gtitool.ui.style.parser.StyledParserPanel.class
      ...
      methods [ METHOD_repaint83 ] = new MethodDescriptor (
          de.unisiegen.gtitool.ui.style.parser.StyledParserPanel.class
              .getMethod ( "repaint", new Class []
              { Long.TYPE, Integer.TYPE, Integer.TYPE, Integer.TYPE,
                  Integer.TYPE } ) ); // NOI18N
      methods [ METHOD_repaint83 ].setDisplayName ( "" );
      methods [ METHOD_requestDefaultFocus84 ] = new MethodDescriptor (
          de.unisiegen.gtitool.ui.style.parser.StyledParserPanel.class
              .getMethod ( "requestDefaultFocus", new Class [] {} ) ); // NOI18N
      methods [ METHOD_requestDefaultFocus84 ].setDisplayName ( "" );
      methods [ METHOD_requestFocus85 ] = new MethodDescriptor (
          de.unisiegen.gtitool.ui.style.parser.StyledParserPanel.class
              .getMethod ( "requestFocus", new Class [] {} ) ); // NOI18N
      methods [ METHOD_requestFocus85 ].setDisplayName ( "" );
      methods [ METHOD_requestFocusInWindow86 ] = new MethodDescriptor (
          de.unisiegen.gtitool.ui.style.parser.StyledParserPanel.class
              .getMethod ( "requestFocusInWindow", new Class [] {} ) ); // NOI18N
      methods [ METHOD_requestFocusInWindow86 ].setDisplayName ( "" );
      methods [ METHOD_resetKeyboardActions87 ] = new MethodDescriptor (
          de.unisiegen.gtitool.ui.style.parser.StyledParserPanel.class
              .getMethod ( "resetKeyboardActions", new Class [] {} ) ); // NOI18N
      methods [ METHOD_resetKeyboardActions87 ].setDisplayName ( "" );
      methods [ METHOD_reshape88 ] = new MethodDescriptor (
          de.unisiegen.gtitool.ui.style.parser.StyledParserPanel.class
              .getMethod ( "reshape", new Class []
              { Integer.TYPE, Integer.TYPE, Integer.TYPE, Integer.TYPE } ) ); // NOI18N
      methods [ METHOD_reshape88 ].setDisplayName ( "" );
      methods [ METHOD_resize89 ] = new MethodDescriptor (
          de.unisiegen.gtitool.ui.style.parser.StyledParserPanel.class
              .getMethod ( "resize", new Class []
              { Integer.TYPE, Integer.TYPE } ) ); // NOI18N
      methods [ METHOD_resize89 ].setDisplayName ( "" );
      methods [ METHOD_revalidate90 ] = new MethodDescriptor (
          de.unisiegen.gtitool.ui.style.parser.StyledParserPanel.class
              .getMethod ( "revalidate", new Class [] {} ) ); // NOI18N
      methods [ METHOD_revalidate90 ].setDisplayName ( "" );
      methods [ METHOD_scrollRectToVisible91 ] = new MethodDescriptor (
          de.unisiegen.gtitool.ui.style.parser.StyledParserPanel.class
              .getMethod ( "scrollRectToVisible", new Class []
              { java.awt.Rectangle.class } ) ); // NOI18N
      methods [ METHOD_scrollRectToVisible91 ].setDisplayName ( "" );
      methods [ METHOD_setBounds92 ] = new MethodDescriptor (
          de.unisiegen.gtitool.ui.style.parser.StyledParserPanel.class
              .getMethod ( "setBounds", new Class []
              { Integer.TYPE, Integer.TYPE, Integer.TYPE, Integer.TYPE } ) ); // NOI18N
      methods [ METHOD_setBounds92 ].setDisplayName ( "" );
      methods [ METHOD_setComponentZOrder93 ] = new MethodDescriptor (
          de.unisiegen.gtitool.ui.style.parser.StyledParserPanel.class
              .getMethod ( "setComponentZOrder", new Class []
              { java.awt.Component.class, Integer.TYPE } ) ); // NOI18N
      methods [ METHOD_setComponentZOrder93 ].setDisplayName ( "" );
      methods [ METHOD_setDefaultLocale94 ] = new MethodDescriptor (
          de.unisiegen.gtitool.ui.style.parser.StyledParserPanel.class
              .getMethod ( "setDefaultLocale", new Class []
              { java.util.Locale.class } ) ); // NOI18N
      methods [ METHOD_setDefaultLocale94 ].setDisplayName ( "" );
      methods [ METHOD_show95 ] = new MethodDescriptor (
          de.unisiegen.gtitool.ui.style.parser.StyledParserPanel.class
              .getMethod ( "show", new Class [] {} ) ); // NOI18N
      methods [ METHOD_show95 ].setDisplayName ( "" );
      methods [ METHOD_size96 ] = new MethodDescriptor (
          de.unisiegen.gtitool.ui.style.parser.StyledParserPanel.class
              .getMethod ( "size", new Class [] {} ) ); // NOI18N
      methods [ METHOD_size96 ].setDisplayName ( "" );
      methods [ METHOD_toString97 ] = new MethodDescriptor (
          de.unisiegen.gtitool.ui.style.parser.StyledParserPanel.class
              .getMethod ( "toString", new Class [] {} ) ); // NOI18N
      methods [ METHOD_toString97 ].setDisplayName ( "" );
      methods [ METHOD_transferFocus98 ] = new MethodDescriptor (
          de.unisiegen.gtitool.ui.style.parser.StyledParserPanel.class
              .getMethod ( "transferFocus", new Class [] {} ) ); // NOI18N
      methods [ METHOD_transferFocus98 ].setDisplayName ( "" );
      methods [ METHOD_transferFocusBackward99 ] = new MethodDescriptor (
          de.unisiegen.gtitool.ui.style.parser.StyledParserPanel.class
              .getMethod ( "transferFocusBackward", new Class [] {} ) ); // NOI18N
      methods [ METHOD_transferFocusBackward99 ].setDisplayName ( "" );
      methods [ METHOD_transferFocusDownCycle100 ] = new MethodDescriptor (
          de.unisiegen.gtitool.ui.style.parser.StyledParserPanel.class
              .getMethod ( "transferFocusDownCycle", new Class [] {} ) ); // NOI18N
      methods [ METHOD_transferFocusDownCycle100 ].setDisplayName ( "" );
      methods [ METHOD_transferFocusUpCycle101 ] = new MethodDescriptor (
          de.unisiegen.gtitool.ui.style.parser.StyledParserPanel.class
              .getMethod ( "transferFocusUpCycle", new Class [] {} ) ); // NOI18N
      methods [ METHOD_transferFocusUpCycle101 ].setDisplayName ( "" );
      methods [ METHOD_unregisterKeyboardAction102 ] = new MethodDescriptor (
          de.unisiegen.gtitool.ui.style.parser.StyledParserPanel.class
              .getMethod ( "unregisterKeyboardAction", new Class []
              { javax.swing.KeyStroke.class } ) ); // NOI18N
      methods [ METHOD_unregisterKeyboardAction102 ].setDisplayName ( "" );
      methods [ METHOD_update103 ] = new MethodDescriptor (
          de.unisiegen.gtitool.ui.style.parser.StyledParserPanel.class
              .getMethod ( "update", new Class []
              { java.awt.Graphics.class } ) ); // NOI18N
      methods [ METHOD_update103 ].setDisplayName ( "" );
      methods [ METHOD_updateUI104 ] = new MethodDescriptor (
          de.unisiegen.gtitool.ui.style.parser.StyledParserPanel.class
              .getMethod ( "updateUI", new Class [] {} ) ); // NOI18N
      methods [ METHOD_updateUI104 ].setDisplayName ( "" );
      methods [ METHOD_validate105 ] = new MethodDescriptor (
          de.unisiegen.gtitool.ui.style.parser.StyledParserPanel.class
              .getMethod ( "validate", new Class [] {} ) ); // NOI18N
  ...
  /**
   * Gets the bean's {@link BeanDescriptor}s.
   * 
  ...
  /**
   * Gets the bean's {@link PropertyDescriptor}s.
   * 
  ...
  /**
   * Gets the bean's {@link EventSetDescriptor}s.
   * 
  ...
  /**
   * Gets the bean's {@link MethodDescriptor}s.
   * 
