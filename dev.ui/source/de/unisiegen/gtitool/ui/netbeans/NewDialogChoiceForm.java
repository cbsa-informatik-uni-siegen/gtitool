...
public class NewDialogChoiceForm extends JPanel implements GUIClass <NewDialogChoice>
{
    ...
    private void initComponents() {
        ...
        jGTIRadioButtonRegex = new de.unisiegen.gtitool.ui.swing.JGTIRadioButton();
        ...
        buttonGroupChoice.add(jGTIRadioButtonRegex);
        jGTIRadioButtonRegex.setText(bundle.getString("NewDialog.REGEX")); // NOI18N
        jGTIRadioButtonRegex.addItemListener(new java.awt.event.ItemListener() {
            public void itemStateChanged(java.awt.event.ItemEvent evt) {
                jGTIRadioButtonRegexItemStateChanged(evt);
            }
        });
        gridBagConstraints = new java.awt.GridBagConstraints();
        gridBagConstraints.gridx = 0;
        ...
        jGTIPanelChoice.add(jGTIRadioButtonRegex, gridBagConstraints);
...
private void jGTIRadioButtonRegexItemStateChanged(java.awt.event.ItemEvent evt) {//GEN-FIRST:event_jGTIRadioButtonRegexItemStateChanged
    logic.handleRegexItemStateChanged(evt);
}//GEN-LAST:event_jGTIRadioButtonRegexItemStateChanged
    ...
    public de.unisiegen.gtitool.ui.swing.JGTIRadioButton jGTIRadioButtonRegex;
