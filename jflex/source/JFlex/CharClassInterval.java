 ...
 * equal to the Unicode value of <CODE>start</code> and smaller than or euqal
 * to the Unicode value of <CODE>end</code>. All characters of the interval
...
public class CharClassInterval
{
   ...
   * @param charClass The code of the class all characters of this interval
   *          belong to.
   */
