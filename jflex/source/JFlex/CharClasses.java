...
public class CharClasses
{
   ...
   * characters from 0 to maxCharCode. Initially all characters are in class 0.
   * 
   * @param maxCharCode the last character code to be considered. (127 for 7bit
   ...
   * 
   * @param charCode the largest character code, used for the scanner (i.e.
   *          %7bit, %8bit, %16bit etc.)
   */
   ...
   * a new character class. Characters that are elements of <code>set</code>
   * are not in the same equivalence class with characters that are not elements
   * of <code>set</code>.
   * 
  ...
  public String toString ()
  {
    ...
    for ( int i = 0 ; i < classes.size () ; i++ )
      result.append ( "class " + i + ":" + Out.NL + classes.elementAt ( i )
          + Out.NL );
   ...
   * <code>v</code> are not in the same equivalence class with characters that
   * are not elements of the set <code>v</code>.
   * 
   * @param v a Vector of Interval objects. This Vector represents a set of
   *          characters. The set of characters is the union of all intervalls
   *          in the Vector.
   * @param caseless if true upper/lower/title case are considered equivalent
   */
   ...
   * 
   * @param intervallVec a Vector of Intervalls, the complement of the set of
  ...
  public CharClassInterval [] getIntervalls ()
  {
    ...
    for ( i = 0 ; i < size ; i++ )
      numIntervalls += ( ( IntCharSet ) classes.elementAt ( i ) )
          .numIntervalls ();
