...
public final class Interval
{
  ...
  /**
   * Return <code>true</code> iff this intervall completely contains the other
   * one.
   * 
  ...
  /**
   * Return <code>true</code> if <code>o</code> is an intervall with the
   * same borders.
   * 
   ...
   * 
   * @return a string <code>"[start-end]"</code> or <code>"[start]"</code>
   *         (if there is only one character in the intervall) where
   *         <code>start</code> and <code>end</code> are either a number
   *         (the character code) or something of the from <code>'a'</code>.
   */
