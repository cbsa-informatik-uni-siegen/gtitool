 ...
 * new RegExp1(sym.STAR, new Character ('a'));
 * 
 * @author Gerwin Klein
...
public class RegExp1 extends RegExp
{
   ...
   * 
   * @param type a value from the cup generated class sym, defining the kind of
   ...
   * 
   * @param tab a String that should contain only space characters and that is
   *          inserted in front of standard String-representation pf this
   *          object.
   */
  public String print ( String tab )
  {
    ...
    {
      return tab + "type = " + type + Out.NL + tab + "content :" + Out.NL
          + ( ( RegExp ) content ).print ( tab + "  " );
    }
    else
      return tab + "type = " + type + Out.NL + tab + "content :" + Out.NL + tab
          + "  " + content;
  }
