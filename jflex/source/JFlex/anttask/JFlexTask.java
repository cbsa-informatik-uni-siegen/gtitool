/*******************************************************************************
 * * * * * * * * * * * * * * * * * * * * * * * * * * * * * * * * * * * * * JFlex
 * Anttask * Copyright (C) 2001 Rafal Mantiuk <Rafal.Mantiuk@bellstream.pl> *
 * Copyright (C) 2003 changes by Gerwin Klein <lsf@jflex.de> * All rights
 ...
 * @version JFlex 1.4.1, $Revision$, $Date: 2007-11-30 00:25:38 +0100 (Fr,
 *          30 Nov 2007) $
 */
@SuppressWarnings (
{ "all" } )
public class JFlexTask extends Task
{
  ...
  /**
   * Sets the actual output directory if not already set. Uses javac logic to
   * determine output dir = dest dir + package name If not destdir has been set,
   * output dir = parent of input file Assumes that package name is already set.
   */
