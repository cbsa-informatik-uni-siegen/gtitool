...
public class GridPanel extends Panel implements Handles
{
  ...
  public void doLayout ()
  {
    ...
    {
      GridPanelConstraint c = ( GridPanelConstraint ) constraints
          .elementAt ( i );
      ...
      c.component.setBounds ( new Rectangle ( ( int ) x, ( int ) y,
  ...
  public void add ( int x, int y, int dx, int dy, int handle, Component c )
  {
    super.add ( c );
    constraints
        .addElement ( new GridPanelConstraint ( x, y, dx, dy, handle, c ) );
  }
}
