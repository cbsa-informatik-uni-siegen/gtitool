...
final public class MainFrame extends Frame implements Handles
{
  ...
  private void buildContent ()
  {
    ...
    if ( font != null )
      messages.setFont ( new Font ( "Monospaced", font.getStyle (), font
          .getSize () ) );
    else
  ...
  private void stop ()
  {
    ...
    {
      /*
       * stop ok here despite deprecation (?) I don't know any good way to abort
       * generation without changing the generator code
       */
      thread.stop ();
      thread = null;
    }
