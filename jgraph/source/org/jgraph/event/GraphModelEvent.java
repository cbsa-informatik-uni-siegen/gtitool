...
public class GraphModelEvent extends EventObject
{
   ...
   * identifying the change as a ModelChange object.
   * 
      ...
      GraphLayoutCacheEvent.GraphLayoutCacheChange
  {
     ...
     * was applied ( an "undo" of the change )
     * 
    ...
    /**
     * Allows a <code>GraphLayoutCache</code> to store cell views for cells
     * that have been removed. Such cell views are used for re-insertion and
     * restoring the visual attributes.
     * 
     ...
     * 
     * @param view the <code>GraphLayoutCache</code> whose stored cells are to
     *          be retrieved
     */
