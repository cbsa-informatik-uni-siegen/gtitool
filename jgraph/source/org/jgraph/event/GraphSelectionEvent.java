/*
 * @(#)GraphSelectionEvent.java 1.0 03-JUL-04 Copyright (c) 2001-2005 Gaudenz
...
public class GraphSelectionEvent extends EventObject
{
   ...
   * return value of false means the cell was in the selection but is no longer
   * in the selection. This will raise if cell is not one of the cells
   ...
   * the selection. A return value of false means the cell was in the selection
   * but is no longer in the selection. This will raise an exception if index <
   * 0 || >=<code>getPaths</code> .length.
   * 
