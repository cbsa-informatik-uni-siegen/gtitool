/*
 * @(#)AbstractCellView.java 1.0 03-JUL-04 Copyright (c) 2001-2005 Gaudenz Alder
...
public abstract class AbstractCellView implements CellView, Serializable
{
  ...
  /**
   * Constructs an empty abstract cell view. You should set a cell on this view
   * using setCell before doing anything. Optionally you can also set a
  ...
  /**
   * Constructs a view for the specified model object, and invokes update on the
   * new instance.
   * 
   ...
   * construction of the instance. Override this and return null if you want to
   * avoid creation of an attribute map at construction time.
   */
   ...
   * @param createDependentViews whether or not to create a view if one does not
   *          already exist
   */
   ...
   * allAttributes, and the location attributes. The result should be stored in
   * allAttributes. This hook is for subclassers to change the merging strategy.
   */
   ...
   * using view.getChildViews. This returns the array in inverse order, ie with
   * the top most cell view at index 0.
   * 
   ...
   * 
   * @param sx the multiple by which the x coordinate position of the cell view
   *          is to be scaled
   * @param sy the multiple by which the y coordinate position of the cell view
   *          is to be scaled
   ...
   * if you use a different renderer. This is because this method relies on the
   * VertexRenderer interface, which can not be safely assumed for subclassers.
   */
