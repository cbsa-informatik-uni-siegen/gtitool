/*
 * @(#)CellView.java 1.0 03-JUL-04 Copyright (c) 2001-2004 Gaudenz Alder
 */
...
public interface CellView
{
  ...
  /**
   * Refresh this view based on the model cell. This is messaged when the model
   * cell has changed.
   */
  void refresh ( GraphLayoutCache cache, CellMapper mapper,
