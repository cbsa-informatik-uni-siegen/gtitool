/*
 * @(#)DefaultCellViewFactory.java 1.0 29-NOV-04 Copyright (c) 2001-2005 Gaudenz
 * Alder
 */
...
public class DefaultCellViewFactory implements CellViewFactory, Serializable
{
   ...
   * specified object using the specified CellMapper. This calls refresh on the
   * created CellView to create all dependent views.
   * <p>
   * Note: The mapping needs to be available before the views of child cells and
   * ports are created. <b>Note: This method must return new instances!</b>
   * 
