/*
 * @(#)DefaultGraphCellEditor.java 1.0 03-JUL-04 Copyright (c) 2001-2004 Gaudenz
 * Alder
 */
    ...
    GraphSelectionListener, Serializable
{
  ...
  /**
   * Constructs a DefaultTreeCellEditor object for a JGraph using the specified
  ...
  public class EditorContainer extends Container
  {
    ...
    /**
     * Returns the preferred size for the Container. This will be the preferred
     * size of the editor offset by offset.
     */
