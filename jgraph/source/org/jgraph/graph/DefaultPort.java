/*
 * Copyright (c) 2001-2006 Gaudenz Alder See LICENSE file in distribution for
...
public class DefaultPort extends DefaultGraphCell implements Port
{
  ...
  /**
   * Constructs a port that holds a reference to the specified user object and a
   * reference to the specified anchor.
   * 
   * @param userObject reference to the user object
