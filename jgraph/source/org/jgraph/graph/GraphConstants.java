/*
 * @(#)GraphConstants.java 1.0 03-JUL-04 Copyright (c) 2001-2004 Gaudenz Alder
 */
...
public class GraphConstants
{
  ...
  {
    return createAttributes ( new Object []
    { cell }, new Object []
    { key }, new Object []
    { value } );
  }
  ...
  {
    return createAttributes ( cells, new Object []
    { key }, new Object []
    { value } );
  }
   ...
   * the modified target map. Note: This method removes entries from
   * <code>change</code> and adds entries to <code>target</code> in-place!
   * 
