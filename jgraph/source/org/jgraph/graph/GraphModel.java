/*
 * @(#)GraphModel.java 1.0 03-JUL-04 Copyright (c) 2001-2004 Gaudenz Alder
 */
...
public interface GraphModel
{
  ...
  /**
   * Inserts the <code>cells</code> and connections into the model, and passes
   * <code>attributes</code> to the views. Notifies the model- and undo
   * listeners of the change.
   */
  void insert ( Object [] roots, Map attributes, ConnectionSet cs,
      ParentMap pm, UndoableEdit [] e );


  /**
   * Removes <code>cells</code> from the model. If <code>removeChildren</code>
   * is <code>true</code>, the children are also removed. Notifies the model-
   * and undo listeners of the change.
   */
   ...
   * listeners of the change. <strong>Note: </strong> If only <code>edits</code>
   ...
   * children. Special care should be taken to replace references between cells.
   */
   ...
   * ModelEvent to be fired to keep the view(s) in sync with the model.
   */
