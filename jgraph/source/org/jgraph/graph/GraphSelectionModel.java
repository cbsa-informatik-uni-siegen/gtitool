/*
 * @(#)GraphSelectionModel.java 0.1 03-JUL-04 Copyright (c) 2001-2004 Gaudenz
 * Alder
 */
...
public interface GraphSelectionModel
{
   ...
   * GraphSelectionListeners are notified. If <code>cell</code> is null, this
   ...
   * GraphSelectionListeners are notified. If <code>cells</code> is null, this
   * has the same effect as invoking <code>clearSelection</code>.
   * 
  ...
  /**
   * Adds cells to the current selection. If any of the cells are not currently
   * in the selection the GraphSelectionListeners are notified. This has no
  ...
  /**
   * Removes cells from the selection. If any of the cells in <code>cells</code>
   * are in the selection, the GraphSelectionListeners are notified. This method
