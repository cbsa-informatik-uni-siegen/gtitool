/*
 * @(#)GraphTransferable.java 1.0 03-JUL-04 Copyright (c) 2001-2004 Gaudenz
 * Alder
 */
    ...
    Serializable, ClipboardOwner
{
  ...
  /**
   * Returns a map of (GraphCell, Map)-pairs that represent the view attributes
   * for the respecive cells.
   */
