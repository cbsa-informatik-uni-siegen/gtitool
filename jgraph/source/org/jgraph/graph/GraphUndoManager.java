/*
 * @(#)GraphUndoManager.java 1.0 03-JUL-04 Copyright (c) 2001-2004 Gaudenz Alder
 */
...
public class GraphUndoManager extends UndoManager
{
   ...
   * the last significant <code>UndoableEdit</code> with respect to source or
   * after, and all insignificant edits up to it. Updates
   * <code>indexOfNextAdd</code> accordingly.
   * <p>
   * If not <code>inProgress</code>, <code>indexOfNextAdd</code> is ignored
   * and super's routine is called.
   * </p>
   */
