...
Nun wird für jede Produktion, wo $\NonterminalSymbol{A}$ auf der rechten Seite vorkommt eine die gleiche Produktion, ohne \NonterminalSymbol{A} auf der rechten Seite angelegt. In unserem Beispiel wird zunächst die Produktion $\NonterminalSymbol{A} \to \TerminalSymbol{c}$ und dann $\StartSymbol{S} \to \TerminalSymbol{a}$ angelegt.
...
Es wurde der Recursive Descent Parser in einer einfachen Programmiersprache.
