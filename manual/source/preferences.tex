...
\Symbols{then}\} eine gültige Eingabe. Außerdem gibt es die Möglichkeit ganze Klassen von geordneten Zeichen als Alphabet anzugeben. Beispiele hierfür wären \Symbol{[a-z]}, \Symbol{[0-9]}, aber auch \Symbol{[a-Z]}.
