...
Wir wollen uns reguläre Ausdrücke anhand des folgenden Beispiels anschauen: \Symbol{(a$|$b)*abb}
...
Oben rechts ist das Eingabefeld für den regulären Ausdruck. Darunter findet man nochmal zur Orientierung das Alphabet, das wir gerade eingegeben haben. Wie bereits oben erwähnt kann das Alphabet nur über den Button "`Dokument editieren"' verändert werden. Im Eingabefeld tragen wir nun unseren Beispielausdruck \Symbol{(a$|$b)*abb} ein.
