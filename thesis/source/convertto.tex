...
($\NonterminalSymbol{S} \to \TerminalSymbol{a}\NonterminalSymbol{A}$), da nur
solche Arten von Produktionen zugelassen sind.\vspace{10pt}
...
Wenn alle Produktion verarbeitet wurden, wird zusätzlich pro
