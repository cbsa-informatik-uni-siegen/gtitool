...
in einen Kellerautomaten umwandeln zu lassen. Dazu wird das Verfahren des
rekursiven Abstiegs verwendet, welches in der Vorlesung vorgestellt
wurde.\vspace{10pt}
...
Zur Umsetzung wurde der in \gticitepage{Compilers}{153ff} angegebene Algorithmus
