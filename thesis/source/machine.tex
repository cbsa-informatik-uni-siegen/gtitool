...
aus denen der Potenzmengenzustand entstanden ist, besser hervorgehoben werden.\vspace{10pt}
...
\subsection{Operationen mit dem Automaten Keller}\label{InteractionPDA}

Ein wichtiger Punkt der Interaktion mit dem Benutzer ist, dass der Benutzer nach
einer Umwandlung einer kontextfreien Grammatik in einen nichtdeterministisch
Kellerautomaten einen Übergang auswählen muss, weil der entstehende Automat
nichtdeterministisch sein muss. Die Umwandlung ist in Abschnitt
...
seiner gemachten Fehlern lernen kann, ohne dass er durch eine Validierung
