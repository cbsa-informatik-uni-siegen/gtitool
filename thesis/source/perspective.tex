...
Dieser Algorithmus kann für eine Implementierung verwendet werden, indem man die
Bedingung für jedes Nichtterminalzeichen überprüft, ob eine Linksfatorisierung
nötig ist, und diese dann wie oben beschrieben anwendet.


\subsection{Wortnavigation für Grammatiken}\label{PerspectiveGrammarWordNavigation}
...
\subsection{Umwandeln}\label{PerspectiveConvertTo}
...
\subsection{Minimieren}\label{PerspectiveMinimize}
...
%###
Wie im Kapitel \ref{AutoLayout} schon erwähnt ist der implementierte Autolayout
