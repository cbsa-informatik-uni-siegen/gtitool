...
\NonterminalSymbol{A}$\alpha_n\ |\ \beta_1\ |\ \ldots\ |\ \beta_k$\vspace{10pt}

\noindent wobei $\beta_1\ $bis$\ \beta_k$ nicht mit \NonterminalSymbol{A}
...
\NonterminalSymbol{A} $\to \beta_1$\NonterminalSymbol{A$'$}$\ |\ \ldots\ |\
\beta_k$\NonterminalSymbol{A$'$}
...
\noindent
\NonterminalSymbol{A}$ \to \alpha $\NonterminalSymbol{A$'$}$\ |\ \gamma_1\ |\
\ldots\ |\ \gamma_k$\\ \NonterminalSymbol{A$'$}$ \to \beta_1\ |\ \ldots\ |\ \beta_n$
\vspace{10pt}
