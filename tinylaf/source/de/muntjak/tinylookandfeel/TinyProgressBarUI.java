...
public class TinyProgressBarUI extends BasicProgressBarUI
{
  ...
  private static final Dimension PREFERRED_99_HORIZONTAL = new Dimension ( 146,
      6 );
  ...
  protected void paintDeterminate ( Graphics g, JComponent c )
  {
    ...
    if ( progressBar.getOrientation () == JProgressBar.HORIZONTAL )
    {
      ...
      switch ( Theme.derivedStyle [ Theme.style ] )
      {
        case Theme.TINY_STYLE :
          drawTinyHorzProgress ( g, b.left, b.top, barRectWidth, barRectHeight,
              amountFull );
          break;
        case Theme.W99_STYLE :
          drawWinHorzProgress ( g, b.left, b.top, barRectWidth, barRectHeight,
              amountFull );
          break;
        case Theme.YQ_STYLE :
    ...
    { // VERTICAL
      ...
      {
        case Theme.TINY_STYLE :
          drawTinyVertProgress ( g, b.left, b.top, barRectWidth, barRectHeight,
              amountFull );
          break;
        case Theme.W99_STYLE :
          drawWinVertProgress ( g, b.left, b.top, barRectWidth, barRectHeight,
              amountFull );
          break;
        case Theme.YQ_STYLE :
  ...
  private void drawWinHorzProgress ( Graphics g, int x, int y, int w, int h,
      int amountFull )
  {
    // paint the track
    g.translate ( x, y );
  ...
  // draw determinate
  private void drawXpHorzProgress ( Graphics g, int x, int y, int w, int h,
      int amountFull )
  {
    g.translate ( x, y );
  ...
  private void drawWinVertProgress ( Graphics g, int x, int y, int w, int h,
      int amountFull )
  {
    // paint the track
    g.translate ( x, y );
  ...
  // draw determinate
  private void drawXpVertProgress ( Graphics g, int x, int y, int w, int h,
      int amountFull )
  {
    g.translate ( x, y );
  ...
  protected void paintIndeterminate ( Graphics g, JComponent c )
  {
    ...
    if ( progressBar.isStringPainted () )
    {
      if ( progressBar.getOrientation () == JProgressBar.HORIZONTAL )
      {
        paintString ( g, b.left, b.top, barRectWidth, barRectHeight, boxRect.x,
            boxRect.width, b );
      }
      else
      {
        paintString ( g, b.left, b.top, barRectWidth, barRectHeight, boxRect.y,
            boxRect.height, b );
      }
    }
  }
   ...
   * 
   * @see javax.swing.plaf.basic.BasicProgressBarUI#paintString(java.awt.Graphics,
  ...
  private void drawTinyVertProgress ( Graphics g, int x, int y, int w, int h,
      Rectangle boxRect )
  {
  }
