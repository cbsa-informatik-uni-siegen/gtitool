...
public class TinyScrollBarUI extends BasicScrollBarUI
{
  ...
  private void drawTinyTrack ( Graphics g, Rectangle t )
  {
    ...
    if ( scrollbar.getOrientation () == JScrollBar.VERTICAL )
    {
      g.setColor ( ColorRoutines.darken ( Theme.scrollTrackColor [ Theme.style ]
          .getColor (), 30 ) );
      ...
      g.setColor ( ColorRoutines.lighten (
          Theme.scrollTrackColor [ Theme.style ].getColor (), 40 ) );
      g.drawLine ( t.x + t.width - 2, t.y + 1, t.x + t.width - 2, t.y
          + t.height - 1 );

      g.setColor ( ColorRoutines.lighten (
          Theme.scrollTrackColor [ Theme.style ].getColor (), 20 ) );
      g.drawLine ( t.x + t.width - 3, t.y + 2, t.x + t.width - 3, t.y
          + t.height - 1 );
    }
    else
    {
      ...
      g.setColor ( ColorRoutines.lighten (
          Theme.scrollTrackColor [ Theme.style ].getColor (), 40 ) );
      g.drawLine ( t.x + 1, t.y + t.height - 2, t.x + t.width - 1, t.y
          + t.height - 2 );

      g.setColor ( ColorRoutines.lighten (
          Theme.scrollTrackColor [ Theme.style ].getColor (), 20 ) );
      g.drawLine ( t.x + 2, t.y + t.height - 3, t.x + t.width - 1, t.y
          + t.height - 3 );
    }
  ...
  private void drawXpTrack ( Graphics g, Rectangle t )
  {
    ...
    {
      g.setColor ( Theme.scrollTrackBorderDisabledColor [ Theme.style ]
          .getColor () );
    }
    ...
    {
      g.drawLine ( t.x, t.y, t.x, t.y + t.height - 1 );
      g.drawLine ( t.x + t.width - 1, t.y, t.x + t.width - 1, t.y + t.height
          - 1 );
    }
    else
    {
      g.drawLine ( t.x, t.y, t.x + t.width - 1, t.y );
      g.drawLine ( t.x, t.y + t.height - 1, t.x + t.width - 1, t.y + t.height
          - 1 );
    }
  }
    ...
    switch ( scrollbar.getOrientation () )
    {
      case JScrollBar.VERTICAL :
        for ( int y = 1 ; y < h ; y++ )
        {
          ...
          {
            yd = halfY - y;
            g.setColor ( ColorRoutines
                .lighten ( c, ( int ) ( yd * spreadStep1 ) ) );
          }
          else if ( y == halfY )
          {
            g.setColor ( c );
  ...
  protected class OrientationChangeListener implements PropertyChangeListener
  {
    ...
    public void propertyChange ( PropertyChangeEvent e )
    {
      ...
      if ( scrollbar.getComponentOrientation ().isLeftToRight () )
      {
        ...
        {
          ( ( TinyScrollButton ) incrButton )
              .setDirection ( orient.intValue () == HORIZONTAL ? EAST : SOUTH );
        }
        if ( decrButton instanceof TinyScrollButton )
        {
          ( ( TinyScrollButton ) decrButton )
              .setDirection ( orient.intValue () == HORIZONTAL ? WEST : NORTH );
        }
      }
      else
      {
        ...
        {
          ( ( TinyScrollButton ) incrButton )
              .setDirection ( orient.intValue () == HORIZONTAL ? WEST : SOUTH );
        }
        if ( decrButton instanceof TinyScrollButton )
        {
          ( ( TinyScrollButton ) decrButton )
              .setDirection ( orient.intValue () == HORIZONTAL ? EAST : NORTH );
        }
      }
    }
  }
