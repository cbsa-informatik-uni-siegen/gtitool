...
public class TinySliderUI extends MetalSliderUI
{
  ...
  private void drawWinThumb ( Graphics g, Color c )
  {
    ...
    if ( slider.getOrientation () == JSlider.HORIZONTAL )
    {
      ...
      {
        g
            .setColor ( Theme.sliderLightDisabledColor [ Theme.style ]
                .getColor () );
      }
      else
      {
      ...
      if ( !slider.isEnabled () )
      {
        g.setColor ( Theme.sliderBorderDisabledColor [ Theme.style ]
            .getColor () );
      }
      else
      {
  ...
  private void drawXpThumb ( Graphics g )
  {
    ...
    if ( slider.getPaintTicks () )
    {
      ...
      if ( slider.getOrientation () == JSlider.HORIZONTAL )
      {
        ...
        else if ( !isDragging && isRollover
            && Theme.sliderRolloverEnabled [ Theme.style ] )
        {
    ...
    { // no ticks painted
      ...
      if ( slider.getOrientation () == JSlider.HORIZONTAL )
      {
        ...
        if ( !slider.isEnabled () )
        {
          g.setColor ( Theme.sliderDarkDisabledColor [ Theme.style ]
              .getColor () );
        }
        else
        {
  ...
  {
    g.setColor ( slider.isEnabled () ? Theme.sliderTickColor [ Theme.style ]
        .getColor () : Theme.sliderTickDisabledColor [ Theme.style ]
        .getColor () );
