...
public class TinyWindowButtonUI extends TinyButtonUI
{
  ...
  public void paint ( Graphics g, JComponent c )
  {
    ...
    {
      frameSelected = ( ( TinyInternalFrameTitlePane ) c.getParent () )
          .isFrameSelected ();
      frameMaximized = ( ( TinyInternalFrameTitlePane ) c.getParent () )
          .isFrameMaximized ();
    }
    ...
    if ( !button.isEnabled () )
    {
      if ( type == CLOSE )
      {
        g.setColor ( Theme.frameSymbolCloseDisabledColor [ Theme.style ]
            .getColor () );
      }
      else
      {
        g
            .setColor ( Theme.frameSymbolDisabledColor [ Theme.style ]
                .getColor () );
      }
    }
    else
  ...
  private void drawTinyButton ( Graphics g, AbstractButton button, Color c,
      int w, int h, boolean frameSelected )
  {
    g.fillRect ( 1, 1, w - 2, h - 2 );
  }


  private void drawWinButton ( Graphics g, AbstractButton button, Color c,
      int w, int h, boolean frameSelected )
  {
    g.fillRect ( 1, 1, w - 2, h - 2 );
  ...
  private void drawXpButton ( Graphics g, AbstractButton button, Color c,
      int w, int h, boolean frameSelected )
  {
    ...
    if ( !button.isEnabled () )
    {
      if ( type == CLOSE )
      {
        col = Theme.frameButtCloseBorderDisabledColor [ Theme.style ]
            .getColor ();
      }
      else
      {
    ...
    if ( !button.isEnabled () )
    {
      if ( type == CLOSE )
      {
        col = Theme.frameButtCloseLightDisabledColor [ Theme.style ]
            .getColor ();
      }
      else
      {
  ...
  private void drawXpLargeButton ( Graphics g, AbstractButton b, Color c,
      int w, int h, boolean frameSelected )
  {
    ...
    if ( !b.isEnabled () )
    {
      if ( type == CLOSE )
      {
        DrawRoutines
            .drawRoundedBorder ( g,
                Theme.frameButtCloseBorderDisabledColor [ Theme.style ]
                    .getColor (), 0, 0, w, h );
      }
      else
      {
        DrawRoutines.drawRoundedBorder ( g,
            Theme.frameButtBorderDisabledColor [ Theme.style ].getColor (), 0,
            0, w, h );
      }
    }
    else
    {
      ...
      {
        DrawRoutines.drawRoundedBorder ( g,
            Theme.frameButtCloseBorderColor [ Theme.style ].getColor (), 0, 0,
            w, h );
      }
      else
      {
    ...
    if ( !frameSelected )
    {
      ...
      else
      {
        if ( type == CLOSE )
        {
          if ( button.getModel ().isPressed () )
          {
            g.setColor ( Theme.frameSymbolClosePressedColor [ Theme.style ]
                .getColor () );
          }
          else
          {
        ...
        else
        {
          if ( button.getModel ().isPressed () )
          {
            g.setColor ( Theme.frameSymbolPressedColor [ Theme.style ]
                .getColor () );
          }
          else
          {
            g.setColor ( Theme.frameSymbolDisabledColor [ Theme.style ]
                .getColor () );
          }
        }
      }
