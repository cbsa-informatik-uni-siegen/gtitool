...
public class TinyToolButtonBorder extends AbstractBorder
{
      ...
      int h )
  {
    ...
    if ( b.isSelected ()
        || ( b.getModel ().isPressed () && b.getModel ().isRollover () ) )
    {
      ...
      int h )
  {
    AbstractButton b = ( AbstractButton ) c;
    Color col = null;
    boolean isFileChooserButton = Boolean.TRUE.equals ( b
  ...
  public Insets getBorderInsets ( Component c )
  {
    ...
    {
      return new Insets ( Theme.toolMarginTop [ Theme.style ],
    ...
    else
    {
      ...
      return new Insets ( margin.top + 1, margin.left + 1, margin.bottom + 1,
          margin.right + 1 );
    }
  }
}
