...
public class ColorReference
{
  ...
  /**
   * Copy-constructor for derived ColorReferences, called only from
   * Theme.loadTheme().
   * 
   * @param other
   */
  ...
  /**
   * Copy-constructor for absolute ColorReferences, called only from
   * Theme.loadTheme().
   * 
   * @param other
   */
  ...
  public void setColor ( int sat, int bri )
  {
    ...
    {
      case MAIN_COLOR :
        c = new ColorUIResource ( SBChooser.getAdjustedColor (
