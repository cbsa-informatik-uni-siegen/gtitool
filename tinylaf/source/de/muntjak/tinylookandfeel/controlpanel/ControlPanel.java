...
/**
 * ControlPanel 28.4.06 Added additional font sizes.
 * 
 * @version 1.1
 * @author Hans Bickel
 */
...
public class ControlPanel
{
  ...
  private static final Border sbFieldBorder = new LineBorder ( Color.DARK_GRAY,
      1 );
  ...
  private static final int menuShortcutKeyMask = Toolkit.getDefaultToolkit ()
  ...
  private SBField mainField, rollField, backField, frameField, sub1Field,
      sub2Field, sub3Field, sub4Field, sub5Field, sub6Field, sub7Field,
      sub8Field;
  ...
  // buttonCP
  private SBField buttonNormalBg, buttonRolloverBg, buttonPressedBg,
      buttonDisabledBg;
  ...
  private SBField buttonRollover, buttonDefault, buttonCheck,
      buttonCheckDisabled;


  private SBField buttonDisabledBorder, buttonDisabledDark,
      buttonDisabledLight;
  ...
  private SBField comboButt, comboButtRollover, comboButtPressed,
      comboButtDisabled;
  ...
  private SBField comboButtBorderDisabled, comboButtDarkDisabled,
      comboButtLightDisabled;
  ...
  private SBField menuInnerHilight, menuInnerShadow, menuOuterHilight,
      menuOuterShadow;
  ...
  // scrollsCP
  private SBField scrollThumbField, scrollButtField, scrollArrowField,
      trackField, scrollThumbRolloverBg, scrollThumbPressedBg,
      scrollThumbDisabledBg, scrollButtRolloverBg, scrollButtPressedBg,
      scrollButtDisabledBg, trackDisabled, trackBorder, trackBorderDisabled,
      scrollArrowDisabled, scrollGripDark, scrollGripLight, scrollPane,
      scrollBorder, scrollDark, scrollLight, scrollBorderDisabled,
      scrollDarkDisabled, scrollLightDisabled;
  ...
  // sliderCP
  private SBField sliderThumbRolloverBg, sliderThumbPressedBg,
      sliderThumbDisabledBg;


  private SBField sliderBorder, sliderDark, sliderLight, sliderThumbField;


  private SBField sliderDisabledBorder, sliderDisabledDark,
      sliderDisabledLight;


  private SBField sliderTrack, sliderTrackBorder, sliderTrackDark,
      sliderTrackLight;
  ...
  private SBField spinnerButtRolloverBg, spinnerButtPressedBg,
      spinnerButtDisabledBg;


  private SBField spinnerBorder, spinnerDark, spinnerLight,
      spinnerArrowDisabled;


  private SBField spinnerDisabledBorder, spinnerDisabledDark,
      spinnerDisabledLight;
  ...
  private SBField toolButt, toolButtRollover, toolButtPressed,
      toolButtSelected;


  private SBField toolBorder, toolBorderPressed, toolBorderRollover,
      toolBorderSelected;
  ...
  private SBField frameButt, frameButtRollover, frameButtPressed,
      frameButtDisabled;
  ...
  private SBField frameButtClose, frameButtCloseRollover,
      frameButtClosePressed, frameButtCloseDisabled;
  ...
  private SBField frameButtBorderDisabled, frameButtDarkDisabled,
      frameButtLightDisabled;


  private SBField frameButtCloseBorder, frameButtCloseDark,
      frameButtCloseLight;


  private SBField frameButtCloseBorderDisabled, frameButtCloseDarkDisabled,
      frameButtCloseLightDisabled;
  ...
  private SBField frameSymbolClose, frameSymbolClosePressed,
      frameSymbolCloseDisabled;


  private SBField frameSymbolCloseDark, frameSymbolCloseLight;


  SpreadControl frameSpreadDark, frameSpreadLight, frameSpreadDarkDisabled,
  ...
  // tipCP
  private SBField tipBg, tipBorder, tipBgDis, tipBorderDis, tipText,
      tipTextDis;
  ...
  {
    JOptionPane.showMessageDialog ( theFrame, "You have been warned!",
  ...
  {
    JOptionPane.showMessageDialog ( theFrame, "Unknown software error. Panic!",
  ...
  {
    JOptionPane.showMessageDialog ( theFrame, msg, "Warning",
  ...
  private void updateSBPopupIcons ()
  {
    ...
    ( ( JMenuItem ) me [ 1 ] ).setIcon ( Theme.mainColor [ Theme.style ]
        .getIcon () );
    ( ( JMenuItem ) me [ 2 ] ).setIcon ( Theme.backColor [ Theme.style ]
        .getIcon () );
    ( ( JMenuItem ) me [ 3 ] ).setIcon ( Theme.disColor [ Theme.style ]
        .getIcon () );
    ( ( JMenuItem ) me [ 4 ] ).setIcon ( Theme.frameColor [ Theme.style ]
        .getIcon () );
    ( ( JMenuItem ) me [ 5 ] ).setIcon ( Theme.sub1Color [ Theme.style ]
        .getIcon () );
    ( ( JMenuItem ) me [ 6 ] ).setIcon ( Theme.sub2Color [ Theme.style ]
        .getIcon () );
    ( ( JMenuItem ) me [ 7 ] ).setIcon ( Theme.sub3Color [ Theme.style ]
        .getIcon () );
    ( ( JMenuItem ) me [ 8 ] ).setIcon ( Theme.sub4Color [ Theme.style ]
        .getIcon () );
    ( ( JMenuItem ) me [ 9 ] ).setIcon ( Theme.sub5Color [ Theme.style ]
        .getIcon () );
    ( ( JMenuItem ) me [ 10 ] ).setIcon ( Theme.sub6Color [ Theme.style ]
        .getIcon () );
    ( ( JMenuItem ) me [ 11 ] ).setIcon ( Theme.sub7Color [ Theme.style ]
        .getIcon () );
    ( ( JMenuItem ) me [ 12 ] ).setIcon ( Theme.sub8Color [ Theme.style ]
        .getIcon () );
  ...
  private void updateHSBPopupIcons ()
  {
    ...
    ( ( JMenuItem ) me [ 0 ] ).setIcon ( Theme.mainColor [ Theme.style ]
        .getIcon () );
    ( ( JMenuItem ) me [ 1 ] ).setIcon ( Theme.backColor [ Theme.style ]
        .getIcon () );
    ( ( JMenuItem ) me [ 2 ] ).setIcon ( Theme.disColor [ Theme.style ]
        .getIcon () );
    ( ( JMenuItem ) me [ 3 ] ).setIcon ( Theme.frameColor [ Theme.style ]
        .getIcon () );
    ( ( JMenuItem ) me [ 4 ] ).setIcon ( Theme.sub1Color [ Theme.style ]
        .getIcon () );
    ( ( JMenuItem ) me [ 5 ] ).setIcon ( Theme.sub2Color [ Theme.style ]
        .getIcon () );
    ( ( JMenuItem ) me [ 6 ] ).setIcon ( Theme.sub3Color [ Theme.style ]
        .getIcon () );
    ( ( JMenuItem ) me [ 7 ] ).setIcon ( Theme.sub4Color [ Theme.style ]
        .getIcon () );
    ( ( JMenuItem ) me [ 8 ] ).setIcon ( Theme.sub5Color [ Theme.style ]
        .getIcon () );
    ( ( JMenuItem ) me [ 9 ] ).setIcon ( Theme.sub6Color [ Theme.style ]
        .getIcon () );
    ( ( JMenuItem ) me [ 10 ] ).setIcon ( Theme.sub7Color [ Theme.style ]
        .getIcon () );
    ( ( JMenuItem ) me [ 11 ] ).setIcon ( Theme.sub8Color [ Theme.style ]
        .getIcon () );
  ...
  private JTabbedPane createDecorationPanel ()
  {
    ...
    compTab.setToolTipTextAt ( 0, "<html>JButton<br>" + "JToggleButton<br>"
        + "JRadioButton<br>" + "JCheckBox" );
    ...
    compTab.setToolTipTextAt ( 2, "<html>JFrame<br>" + "JInternalFrame<br>"
        + "JDialog<br>" + "JOptionPane" );
    ...
    compTab.setToolTipTextAt ( 5, "<html>JMenu<br>" + "JMenuItem<br>"
        + "JCheckBoxMenuItem<br>" + "JRadioButtonMenuItem" );
    ...
    compTab.setToolTipTextAt ( 8, "<html>JScrollPane<br>" + "JScrollBar" );
    ...
    compTab.setToolTipTextAt ( 14, "<html>JTextField<br>"
        + "JFormattedTextField<br>" + "JTextArea<br>" + "JPasswordField<br>"
        + "JSpinner.Editor<br>" + "JComboBox.Editor" );

    toolCP = new ToolBarCP ();
    compTab.add ( "ToolBar", toolCP );
    compTab.setToolTipTextAt ( 15, "<html>JToolBar<br>" + "ToolBar Button<br>"
        + "JToolBar.Separator" );
  ...
  private JMenu createStyleMenu ()
  {
    ...
    item = new JCheckBoxMenuItem ( "99 Style",
        ( Theme.style == Theme.W99_STYLE ) );
    group.add ( item );
    item.addActionListener ( new ActionListener ()
    {
  ...
  private JMenu createTestMenu ()
  {
    ...
    item = new JMenuItem (
        "<html><b>Note: </b>For JMenuItems displaying HTML text<br>"
    ...
    if ( b && exampleButton.getIcon () == null )
    {
      if ( buttonIcon == null )
      {
        buttonIcon = new ImageIcon (
            ClassLoader
                .getSystemResource ( "de/muntjak/tinylookandfeel/icons/theIcon.gif" ) );
      }
  ...
  private void updateFont ( int type )
  {
    if ( type == PLAIN_FONT )
    {
      Theme.plainFont [ Theme.style ].setFont ( plainFontPanel
          .getCurrentFont () );
    }
    ...
    {
      selectedFont [ Theme.style ]
          .setFont ( specialFontPanel.getCurrentFont () );
    }
  ...
  private void openTheme ()
  {
    ...
    if ( !Theme.loadTheme ( f, Theme.CUSTOM_STYLE ) )
    {
      JOptionPane.showMessageDialog ( theFrame,
          "This file is no valid TinyLaF theme.", "Error loading file",
  ...
  private void saveTheme ( boolean showFileChooser )
  {
    ...
    ch.setFileFilter ( new ThemeFileFilter () );
    ch.setSelectedFile ( new File ( System.getProperty ( "user.dir" )
        + File.separator + "Untitled.theme" ) );
  ...
  public class SBField extends JPanel
  {
    ...
    class Mousey extends MouseAdapter
    {
      ...
      public void mousePressed ( MouseEvent e )
      {
        ...
        if ( e.getX () > cf.getWidth () - 19
            && !ref [ Theme.style ].isLocked () )
        {
          showSBPopup ( cf );
          return;
        }
        ...
        if ( ref [ Theme.style ].isAbsoluteColor () )
        {
          newColor = PSColorChooser
              .showColorChooser ( theFrame, cf.getColor () );
        ...
        else
        {
          ...
          cf.getColorReference ().setColor ( SBChooser.getSat (),
              SBChooser.getBri () );
          cf.setBackground ( newColor );
        }
  ...
  class HSBField extends JPanel
  {
    ...
    public void setReference ( int newReference, boolean updateHue )
    {
      ...
      if ( updateHue )
      {
        hue = ColorRoutines.calculateHue ( ColorReference
            .getReferenceColor ( reference ) );
      }
    ...
    public void update ()
    {
      if ( ref != null )
      {
        setBackground ( calculateBackground ( ColorReference
            .getReferenceColor ( reference ) ) );
      }
      repaint ();
      updateTTT ();
    ...
    class Mousey extends MouseAdapter
    {
      ...
      public void mousePressed ( MouseEvent e )
      {
        ...
        if ( !HSBChooser.showColorizeDialog ( theFrame, cf ) )
        { // cancelled
          cf.hue = memHue;
          cf.sat = memSat;
          cf.bri = memBri;
  ...
  class FontPanel extends JPanel
  {
    ...
    private void setupUI ()
    {
      ...
      {
        colorField = new SBField ( selectedFont [ Theme.style ]
            .getColorReference (), true );
        add ( colorField );
      }
    }
    ...
    {
      return Integer.parseInt ( ( String ) fontSizeCombo.getSelectedItem () );
    }
    ...
    {
      return new FontUIResource ( getFontFamily (), getFontType (),
          getFontSize () );
    ...
    public void init ( ColoredFont f )
    {
      resistUpdate = true;
      fontSizeCombo
          .setSelectedItem ( String.valueOf ( f.getFont ().getSize () ) );
      fontFamilyCombo.setSelectedItem ( f.getFont ()
          .getFamily ( Locale.GERMANY ) );
  ...
  class ExamplePanel extends JPanel
  {
    ...
    private void setupUI ()
    {
      ...
      sp = new JScrollPane ( sizey, JScrollPane.VERTICAL_SCROLLBAR_ALWAYS,
          JScrollPane.HORIZONTAL_SCROLLBAR_ALWAYS );
      sp.setPreferredSize ( new Dimension ( 96, 96 ) );
      sp.getVerticalScrollBar ().setUnitIncrement ( 4 );
      sp.getHorizontalScrollBar ().setUnitIncrement ( 4 );
      ...
      sp = new JScrollPane ( list, JScrollPane.VERTICAL_SCROLLBAR_AS_NEEDED,
      ...
      sp = new JScrollPane ( p5, JScrollPane.VERTICAL_SCROLLBAR_ALWAYS,
          JScrollPane.HORIZONTAL_SCROLLBAR_AS_NEEDED );
      p1.add ( sp );
      scrollBars [ 3 ] = sp;
      ...
      p2.add ( spinner );
      p2.add ( new JLabel ( " " ) );
      spinner = new JSpinner ( new SpinnerDateModel ( new Date (), null, null,
      ...
      tree1.expandPath ( tree1.getNextMatch ( "colors", 0,
          Position.Bias.Forward ) );
      tree1
          .expandPath ( tree1.getNextMatch ( "food", 0, Position.Bias.Forward ) );
      tree1.setVisibleRowCount ( 10 );
      sp1 = new JScrollPane ( tree1, JScrollPane.VERTICAL_SCROLLBAR_AS_NEEDED,
          JScrollPane.HORIZONTAL_SCROLLBAR_AS_NEEDED );
      sp1
          .setViewportBorder ( BorderFactory.createLineBorder ( Color.WHITE, 2 ) );
      p2.add ( sp1 );
      scrollBars [ 4 ] = sp1;

      tree2 = new JTree ();
      tree2.setCellRenderer ( new SwitchTreeIcons ( true ) );
      DefaultMutableTreeNode root = ( DefaultMutableTreeNode ) tree2
          .getModel ().getRoot ();
      root.setUserObject ( "JTree disabled" );
      tree2.getModel ().valueForPathChanged ( new TreePath ( root.getPath () ),
          "JTree disabled" );
      tree2.expandPath ( tree2.getNextMatch ( "sports", 0,
          Position.Bias.Forward ) );
      tree2.setEnabled ( false );
      tree2.setVisibleRowCount ( 10 );
      sp2 = new JScrollPane ( tree2, JScrollPane.VERTICAL_SCROLLBAR_AS_NEEDED,
          JScrollPane.HORIZONTAL_SCROLLBAR_AS_NEEDED );
      sp2
          .setViewportBorder ( BorderFactory.createLineBorder ( Color.WHITE, 2 ) );
      p2.add ( sp2 );
      ...
      check.addActionListener ( new ActionListener ()
      {
        ...
        public void actionPerformed ( ActionEvent e )
        {
          SwitchTreeIcons renderer = ( SwitchTreeIcons ) tree1
              .getCellRenderer ();
          renderer.setShowIcons ( ( ( AbstractButton ) e.getSource () )
              .isSelected () );

          renderer = ( SwitchTreeIcons ) tree2.getCellRenderer ();
          renderer.setShowIcons ( ( ( AbstractButton ) e.getSource () )
              .isSelected () );
      ...
      check.addActionListener ( new ActionListener ()
      {
        ...
        public void actionPerformed ( ActionEvent e )
        {
          vertProgressBar.setStringPainted ( ( ( AbstractButton ) e
              .getSource () ).isSelected () );
          horzProgressBar.setStringPainted ( ( ( AbstractButton ) e
              .getSource () ).isSelected () );
        }
      } );
      p2.add ( check, gc );
    ...
    private JComboBox createCombo ( String s )
    {
      ...
      { s, "can have", "zero to", "many items", "and can be", "triggered",
          "many times" } );
    }
    ...
    class DesktopPane extends JDesktopPane
    {
      ...
      private void setupUI ()
      {
        ...
        exampleTable.setDefaultRenderer ( TinyTableModel.TableColorIcon.class,
            new IconRenderer () );
        ...
        internalFrame = new JInternalFrame ( "InternalFrame", true, true, true,
            true );
        ...
        defaultButton.addActionListener ( new ActionListener ()
        {
          ...
          public void actionPerformed ( ActionEvent e )
          {
            JOptionPane.showInternalMessageDialog ( palette,
                "Life is a while(true) loop." );
          }
        } );
        ...
        b.addActionListener ( new ActionListener ()
        {
          ...
          public void actionPerformed ( ActionEvent e )
          {
            JOptionPane.showInternalConfirmDialog ( palette,
                "Is programming art?" );
          }
        } );
  ...
  class ScrollBarCP extends JPanel
  {
    ...
    private void setupUI ()
    {
      ...
      gc.gridy++ ;
      gc.insets = new Insets ( 1, 8, 0, 4 );
      scrollSpreadLight = new SpreadControl ( Theme.scrollSpreadLight, 20,
          CONTROLS_SCROLLBAR );
      ...
      gc.gridy++ ;
      gc.insets = new Insets ( 1, 8, 0, 4 );
      scrollSpreadDark = new SpreadControl ( Theme.scrollSpreadDark, 20,
          CONTROLS_SCROLLBAR );
      ...
      gc.gridy++ ;
      gc.insets = new Insets ( 1, 8, 0, 4 );
      scrollDarkDisabled = new SBField ( Theme.scrollDarkDisabledColor, false,
          true );
  ...
  class SliderCP extends JPanel
  {
    ...
    void init ( boolean always )
    {
      ...
      rolloverEnabled
          .setSelected ( Theme.sliderRolloverEnabled [ Theme.style ] );
    ...
    void updateTheme ()
    {
      ...
      Theme.sliderRolloverEnabled [ Theme.style ] = rolloverEnabled
          .isSelected ();
  ...
  class ToolBarCP extends JPanel
  {
    ...
    void init ( boolean always )
    {
      ...
      mBottom
          .setValue ( new Integer ( Theme.toolMarginBottom [ Theme.style ] ) );
    ...
    void updateTheme ()
    {
      ...
      Theme.toolMarginTop [ Theme.style ] = ( ( Integer ) mTop.getValue () )
          .intValue ();
      Theme.toolMarginLeft [ Theme.style ] = ( ( Integer ) mLeft.getValue () )
          .intValue ();
      Theme.toolMarginBottom [ Theme.style ] = ( ( Integer ) mBottom
          .getValue () ).intValue ();
      Theme.toolMarginRight [ Theme.style ] = ( ( Integer ) mRight.getValue () )
          .intValue ();
    }
  }
  ...
  class TableCP extends JPanel
  {
    ...
    private void setupUI ()
    {
      ...
      gc.gridy++ ;
      gc.insets = new Insets ( 1, 8, 0, 4 );
      tableHeaderRolloverBack = new SBField (
          Theme.tableHeaderRolloverBackColor );
      ...
      check.addActionListener ( new ActionListener ()
      {
        ...
        {
          JCheckBox check = ( JCheckBox ) e.getSource ();
          exampleTable.getTableHeader ().setReorderingAllowed (
              check.isSelected () );
        }
      } );
      p.add ( check );
      ...
      check.addActionListener ( new ActionListener ()
      {
        ...
        {
          JCheckBox check = ( JCheckBox ) e.getSource ();
          exampleTable.getTableHeader ().setResizingAllowed (
              check.isSelected () );
        }
      } );
      p.add ( check );
  ...
  class SpinnerCP extends JPanel
  {
    ...
    private void setupUI ()
    {
      ...
      gc.gridy++ ;
      gc.insets = new Insets ( 1, 8, 0, 4 );
      spinnerSpreadLight = new SpreadControl ( Theme.spinnerSpreadLight, 20,
          CONTROLS_SPINNER );
      ...
      gc.gridy++ ;
      gc.insets = new Insets ( 1, 8, 0, 4 );
      spinnerSpreadDark = new SpreadControl ( Theme.spinnerSpreadDark, 20,
          CONTROLS_SPINNER );
      ...
      gc.gridy++ ;
      gc.insets = new Insets ( 1, 8, 0, 4 );
      spinnerDisabledDark = new SBField ( Theme.spinnerDarkDisabledColor,
          false, true );
      ...
      gc.gridy++ ;
      gc.insets = new Insets ( 1, 8, 0, 4 );
      spinnerDisabledLight = new SBField ( Theme.spinnerLightDisabledColor,
          false, true );
  ...
  class TabbedPaneCP extends JPanel
  {
    ...
    private JCheckBox rolloverEnabled, focusEnabled, ignoreSelectedBg,
        fixedTabs;
    ...
    void init ( boolean always )
    {
      ...
      tabBottom
          .setValue ( new Integer ( Theme.tabInsets [ Theme.style ].bottom ) );
      tabRight
          .setValue ( new Integer ( Theme.tabInsets [ Theme.style ].right ) );

      areaTop
          .setValue ( new Integer ( Theme.tabAreaInsets [ Theme.style ].top ) );
      areaLeft.setValue ( new Integer (
          Theme.tabAreaInsets [ Theme.style ].left ) );
      areaBottom.setValue ( new Integer (
          Theme.tabAreaInsets [ Theme.style ].bottom ) );
      areaRight.setValue ( new Integer (
          Theme.tabAreaInsets [ Theme.style ].right ) );
    ...
    void updateTheme ()
    {
      ...
      Theme.tabInsets [ Theme.style ] = new Insets ( ( ( Integer ) tabTop
          .getValue () ).intValue (), ( ( Integer ) tabLeft.getValue () )
          .intValue (), ( ( Integer ) tabBottom.getValue () ).intValue (),
          ( ( Integer ) tabRight.getValue () ).intValue () );

      Theme.tabAreaInsets [ Theme.style ] = new Insets ( ( ( Integer ) areaTop
          .getValue () ).intValue (), ( ( Integer ) areaLeft.getValue () )
          .intValue (), ( ( Integer ) areaBottom.getValue () ).intValue (),
  ...
  class TextCP extends JPanel
  {
    ...
    private void setupUI ()
    {
      ...
      gc.gridy++ ;
      gc.insets = new Insets ( 1, 8, 0, 4 );
      textDisabledDark = new SBField ( Theme.textBorderDarkDisabledColor,
          false, true );
      ...
      gc.gridy++ ;
      gc.insets = new Insets ( 1, 8, 0, 4 );
      textDisabledLight = new SBField ( Theme.textBorderLightDisabledColor,
          false, true );
    ...
    void init ( boolean always )
    {
      ...
      mBottom
          .setValue ( new Integer ( Theme.textInsets [ Theme.style ].bottom ) );
    ...
    void updateTheme ()
    {
      ...
      Theme.textInsets [ Theme.style ] = new Insets ( ( ( Integer ) mTop
          .getValue () ).intValue (), ( ( Integer ) mLeft.getValue () )
          .intValue (), ( ( Integer ) mBottom.getValue () ).intValue (),
  ...
  class IconCP extends JPanel
  {
    ...
    private void setupUI ()
    {
      ...
      for ( int i = 0 ; i < 20 ; i++ )
      {
        ...
        iconChecks [ i ] = new CheckedIcon (
            Theme.colorize [ Theme.style ] [ i ], hsb [ i ], TinyLookAndFeel
                .getSystemIconName ( i ) );
      }
    ...
    void init ( boolean always )
    {
      ...
      for ( int i = 0 ; i < 20 ; i++ )
      {
        iconChecks [ i ].setIcon ( TinyLookAndFeel
            .getUncolorizedSystemIcon ( i ) );
        iconChecks [ i ].setSelected ( Theme.colorize [ Theme.style ] [ i ] );
        hsb [ i ].setHue ( Theme.colorizer [ i ] [ Theme.style ].getHue () );
        hsb [ i ].setSaturation ( Theme.colorizer [ i ] [ Theme.style ]
            .getSaturation () );
        hsb [ i ].setBrightness ( Theme.colorizer [ i ] [ Theme.style ]
            .getBrightness () );
        hsb [ i ].setPreserveGrey ( Theme.colorizer [ i ] [ Theme.style ]
            .isPreserveGrey () );
        hsb [ i ].setReference ( Theme.colorizer [ i ] [ Theme.style ]
            .getReference (), false );
    ...
    void updateTheme ()
    {
      ...
      for ( int i = 0 ; i < 20 ; i++ )
      {
        ...
        Theme.colorizer [ i ] [ Theme.style ].setSaturation ( hsb [ i ]
            .getSaturation () );
        Theme.colorizer [ i ] [ Theme.style ].setBrightness ( hsb [ i ]
            .getBrightness () );
        Theme.colorizer [ i ] [ Theme.style ].setPreserveGrey ( hsb [ i ]
            .isPreserveGrey () );
        Theme.colorizer [ i ] [ Theme.style ].setReference ( hsb [ i ]
            .getReference () );
      }
    }
    ...
    public void colorizeIcon ( HSBField field, boolean doColorize )
    {
      for ( int i = 0 ; i < 20 ; i++ )
      {
        if ( field.equals ( hsb [ i ] ) )
        {
          if ( doColorize )
          {
            Icon icon = DrawRoutines.colorize ( ( ( ImageIcon ) TinyLookAndFeel
                .getUncolorizedSystemIcon ( i ) ).getImage (), field.hue,
                field.sat, field.bri, field.preserveGrey );
  ...
  class ComboCP extends JPanel
  {
    ...
    private void setupUI ()
    {
      ...
      gc.gridy++ ;
      gc.insets = new Insets ( 1, 8, 0, 4 );
      comboDisabledDark = new SBField ( Theme.comboDarkDisabledColor, false,
          true );
      ...
      gc.gridy++ ;
      gc.insets = new Insets ( 1, 8, 0, 4 );
      comboDisabledLight = new SBField ( Theme.comboLightDisabledColor, false,
          true );
      ...
      gc.gridy++ ;
      gc.insets = new Insets ( 1, 8, 0, 4 );
      comboSpreadLight = new SpreadControl ( Theme.comboSpreadLight, 20,
          CONTROLS_COMBO );
      ...
      gc.gridy++ ;
      gc.insets = new Insets ( 1, 8, 0, 4 );
      comboSpreadDark = new SpreadControl ( Theme.comboSpreadDark, 20,
          CONTROLS_COMBO );
      ...
      gc.gridy++ ;
      gc.insets = new Insets ( 1, 8, 0, 4 );
      comboButtBorderDisabled = new SBField (
          Theme.comboButtBorderDisabledColor );
      ...
      gc.gridy++ ;
      gc.insets = new Insets ( 1, 8, 0, 4 );
      comboButtDarkDisabled = new SBField ( Theme.comboButtDarkDisabledColor,
          false, true );
      ...
      gc.gridy++ ;
      gc.insets = new Insets ( 1, 8, 0, 4 );
      comboButtLightDisabled = new SBField ( Theme.comboButtLightDisabledColor,
          false, true );
    ...
    void init ( boolean always )
    {
      ...
      mBottom
          .setValue ( new Integer ( Theme.comboInsets [ Theme.style ].bottom ) );
      mRight
          .setValue ( new Integer ( Theme.comboInsets [ Theme.style ].right ) );
    ...
    void updateTheme ()
    {
      ...
      Theme.comboInsets [ Theme.style ] = new Insets ( ( ( Integer ) mTop
          .getValue () ).intValue (), ( ( Integer ) mLeft.getValue () )
          .intValue (), ( ( Integer ) mBottom.getValue () ).intValue (),
          ( ( Integer ) mRight.getValue () ).intValue () );
    }
  ...
  class ButtonsCP extends JPanel
  {
    ...
    private void setupUI ()
    {
      ...
      gc.gridy++ ;
      gc.insets = new Insets ( 1, 8, 0, 4 );
      buttonSpreadLight = new SpreadControl ( Theme.buttonSpreadLight, 20,
          CONTROLS_BUTTON );
      ...
      gc.gridy++ ;
      gc.insets = new Insets ( 1, 8, 0, 4 );
      buttonSpreadDark = new SpreadControl ( Theme.buttonSpreadDark, 20,
          CONTROLS_BUTTON );
      ...
      JLabel info = new JLabel (
          "<html>For toolbar buttons choose <b>'ToolBar'</b>" );
      p1.add ( info, gc );
      ...
      gc.gridy++ ;
      gc.insets = new Insets ( 1, 8, 0, 4 );
      buttonDisabledDark = new SBField ( Theme.buttonDarkDisabledColor, false,
          true );
      ...
      gc.gridy++ ;
      gc.insets = new Insets ( 1, 8, 0, 4 );
      buttonDisabledLight = new SBField ( Theme.buttonLightDisabledColor,
          false, true );
    ...
    void init ( boolean always )
    {
      ...
      mBottom
          .setValue ( new Integer ( Theme.buttonMarginBottom [ Theme.style ] ) );
      mRight
          .setValue ( new Integer ( Theme.buttonMarginRight [ Theme.style ] ) );

      cTop.setValue ( new Integer ( Theme.checkMarginTop [ Theme.style ] ) );
      cLeft.setValue ( new Integer ( Theme.checkMarginLeft [ Theme.style ] ) );
      cBottom
          .setValue ( new Integer ( Theme.checkMarginBottom [ Theme.style ] ) );
    ...
    {
      return new InsetsUIResource ( ( ( Integer ) mTop.getValue () )
          .intValue (), ( ( Integer ) mLeft.getValue () ).intValue (),
          ( ( Integer ) mBottom.getValue () ).intValue (), ( ( Integer ) mRight
              .getValue () ).intValue () );
    }
    ...
    void updateTheme ()
    {
      ...
      Theme.buttonFocusBorder [ Theme.style ] = focusBorderEnabled
          .isSelected ();
      Theme.buttonEnter [ Theme.style ] = enterEnabled.isSelected ();
      Theme.shiftButtonText [ Theme.style ] = shiftTextEnabled.isSelected ();

      Theme.buttonMarginTop [ Theme.style ] = ( ( Integer ) mTop.getValue () )
          .intValue ();
      Theme.buttonMarginLeft [ Theme.style ] = ( ( Integer ) mLeft.getValue () )
          .intValue ();
      Theme.buttonMarginBottom [ Theme.style ] = ( ( Integer ) mBottom
          .getValue () ).intValue ();
      Theme.buttonMarginRight [ Theme.style ] = ( ( Integer ) mRight
          .getValue () ).intValue ();

      Theme.checkMarginTop [ Theme.style ] = ( ( Integer ) cTop.getValue () )
          .intValue ();
      Theme.checkMarginLeft [ Theme.style ] = ( ( Integer ) cLeft.getValue () )
          .intValue ();
      Theme.checkMarginBottom [ Theme.style ] = ( ( Integer ) cBottom
          .getValue () ).intValue ();
      Theme.checkMarginRight [ Theme.style ] = ( ( Integer ) cRight.getValue () )
          .intValue ();
    }
  ...
  class FrameFrameCP extends JPanel
  {
    ...
    private void setupUI ()
    {
      ...
      gc.gridy++ ;
      gc.insets = new Insets ( 1, 8, 0, 4 );
      frameSpreadDark = new SpreadControl ( Theme.frameSpreadDark, 10,
          CONTROLS_ACTIVE_FRAME_CAPTION );
      ...
      gc.gridy++ ;
      gc.insets = new Insets ( 1, 8, 0, 4 );
      frameSpreadLight = new SpreadControl ( Theme.frameSpreadLight, 10,
          CONTROLS_ACTIVE_FRAME_CAPTION );
      ...
      gc.gridy++ ;
      gc.insets = new Insets ( 1, 8, 0, 4 );
      frameDarkDisabled = new SBField ( Theme.frameDarkDisabledColor, false,
          true );
  ...
  class FrameButtonsCP extends JPanel
  {
    ...
    private void setupUI ()
    {
      ...
      gc.gridy++ ;
      gc.insets = new Insets ( 1, 8, 0, 4 );
      frameButtSpreadLight = new SpreadControl ( Theme.frameButtSpreadLight,
          20, CONTROLS_WINDOW_BUTTON );
      ...
      gc.gridy++ ;
      gc.insets = new Insets ( 1, 8, 0, 4 );
      frameButtSpreadDark = new SpreadControl ( Theme.frameButtSpreadDark, 20,
          CONTROLS_WINDOW_BUTTON );
      ...
      gc.gridy++ ;
      gc.insets = new Insets ( 1, 8, 0, 4 );
      frameButtBorderDisabled = new SBField (
          Theme.frameButtBorderDisabledColor );
  ...
  class FrameCloseButtonCP extends JPanel
  {
    ...
    private void setupUI ()
    {
      ...
      gc.gridy++ ;
      gc.insets = new Insets ( 1, 8, 0, 4 );
      frameButtCloseBorderDisabled = new SBField (
          Theme.frameButtCloseBorderDisabledColor );
      ...
      gc.gridy++ ;
      gc.insets = new Insets ( 1, 8, 0, 4 );
      frameButtCloseDarkDisabled = new SBField (
          Theme.frameButtCloseDarkDisabledColor );
      ...
      gc.gridy++ ;
      gc.insets = new Insets ( 1, 8, 0, 4 );
      frameButtCloseLightDisabled = new SBField (
          Theme.frameButtCloseLightDisabledColor );
      ...
      gc.gridy++ ;
      gc.insets = new Insets ( 1, 8, 0, 4 );
      frameSymbolClosePressed = new SBField (
          Theme.frameSymbolClosePressedColor );
      ...
      gc.gridy++ ;
      gc.insets = new Insets ( 1, 8, 0, 4 );
      frameSymbolCloseDisabled = new SBField (
          Theme.frameSymbolCloseDisabledColor );
  ...
  class SpreadControl extends JPanel implements FocusListener
  {
    ...
    public void update ( int spread )
    {
      ...
      else if ( controlMode == CONTROLS_ACTIVE_FRAME_CAPTION )
      {
        if ( decoratedFramesCheck.isSelected () )
        {
          ...
          Component [] cs = theFrame.getLayeredPane ().getComponentsInLayer (
    ...
    public void paint ( Graphics g )
    {
      ...
      g.drawString ( String.valueOf ( spread ), getWidth () - xd - 3,
          getHeight () - 5 );
    }
  ...
  class SelectThemeAction implements ActionListener
  {
    ...
    public void actionPerformed ( ActionEvent e )
    {
      openTheme ( ( ( JMenuItem ) e.getSource () ).getText ()
          + Theme.FILE_EXTENSION );
    }
  }
  ...
  class PopupTrigger extends JPanel implements MouseListener
  {
    ...
    public void mousePressed ( MouseEvent e )
    {
      if ( thePopup != null && thePopup.isShowing () )
        return;
      ...
      thePopup.show ( e.getComponent (), 0,
          -thePopup.getPreferredSize ().height - 1 );
    }
  ...
  private class AboutDialog extends JDialog
  {
    ...
    AboutDialog ()
    {
      ...
      String msg = "<html>" + "TinyLaF v" + TinyLookAndFeel.VERSION_STRING
          + " (" + TinyLookAndFeel.DATE_STRING + ")"
