...
/**
 * This TableCellRenderer is installed on the table header in
 * TinyTableHeaderUI.installDefaults() so we can change the border on rollover
 * and show an arrow icon for sorted columns.
 * 
 * @author Hans Bickel
 */
@SuppressWarnings (
{ "all" } )
public class TinyTableHeaderRenderer extends DefaultTableCellRenderer implements
    UIResource
{
  ...
  /**
   * Sets horizontal alignments of renderers where an index in the argument
   * array corresponds to a column index.
   * 
      ...
      boolean isSelected, boolean hasFocus, int row, int column )
  {
    ...
    if ( table != null )
    {
      ...
      if ( header != null )
      {
        ...
        if ( isRolloverColumn )
        {
          setBackground ( Theme.tableHeaderRolloverBackColor [ Theme.style ]
              .getColor () );
        }
        else
        {
